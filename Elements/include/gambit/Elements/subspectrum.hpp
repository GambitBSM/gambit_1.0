...
namespace Gambit {
   ...
   void SubSpectrum::add_uncertainty(double rd, Par::Phys tag, std::vector<str>& params)
   {
      add_uncertainty_high(rd, tag, params);
      add_uncertainty_low(rd, tag, params);
   }

   void SubSpectrum::add_uncertainty_high(double rd, Par::Phys tag, std::vector<str>& params)
   {
      for(std::vector<str>::iterator it = params.begin();
	  it != params.end(); ++it)
	{
   ...
   void SubSpectrum::add_uncertainty_low(double rd, Par::Phys tag, std::vector<str>& params)
   {
      for(std::vector<str>::iterator it = params.begin();
	  it != params.end(); ++it)
	{
   ...
   void SubSpectrum::add_uncertainty(double rd, Par::Phys tag, str& par)
   {
   ...
   void SubSpectrum::add_uncertainty_high(double rd, Par::Phys tag, str& par)
   {
     std::vector<str> params;
     params.push_back(par);
     add_uncertainty_high(rd, tag, params);
   ...
   void SubSpectrum::add_uncertainty_low(double rd, Par::Phys tag, str& par)
   {
     std::vector<str> params;
     params.push_back(par);
     add_uncertainty_low(rd, tag, params);
   ...
   void SubSpectrum::add_uncertainty(double rd, Par::Phys tag, std::vector<str>& params, std::vector<int> indices)
   {
      add_uncertainty_high(rd, tag, params, indices);
      add_uncertainty_low(rd, tag, params, indices);
   }

   void SubSpectrum::add_uncertainty_high(double rd, Par::Phys tag, std::vector<str>& params, std::vector<int> indices)
   {
      for(std::vector<str>::iterator it = params.begin();
	  it != params.end(); ++it)
	{
   ...
   void SubSpectrum::add_uncertainty_low(double rd, Par::Phys tag, std::vector<str>& params, std::vector<int> indices)
   {
      for(std::vector<str>::iterator it = params.begin();
	  it != params.end(); ++it)
	{
   ...
   void SubSpectrum::add_uncertainty(double rd, Par::Phys tag, str& par, int i)
   {
     std::vector<str> params;
   ...
   void SubSpectrum::add_uncertainty_high(double rd, Par::Phys tag, str& par, int i)
   {
     std::vector<str> params;
     std::vector<int> indices;
     params.push_back(par);
   ...
   void SubSpectrum::add_uncertainty_low(double rd, Par::Phys tag, str& par, int i)
   {
     std::vector<str> params;
     std::vector<int> indices;
     params.push_back(par);
   ...
   void SubSpectrum::add_uncertainty(double rd, Par::Phys tag, str& par, std::vector<int> indices)
   {
     std::vector<str> params;
     params.push_back(par);
     add_uncertainty(rd, tag, params, indices);
   ...
   void SubSpectrum::add_uncertainty_high(double rd, Par::Phys tag, str& par, std::vector<int> indices)
   {
     std::vector<str> params;
     params.push_back(par);
     add_uncertainty_high(rd, tag, params, indices);
   ...
   void SubSpectrum::add_uncertainty_low(double rd, Par::Phys tag, str& par, std::vector<int> indices)
   {
     std::vector<str> params;
     params.push_back(par);
     add_uncertainty_low(rd, tag, params, indices);
   ...
   void SubSpectrum::add_uncertainty(double rd, Par::Phys tag, std::vector<str>& params, int i)
   {
     std::vector<int> indices;
     indices.push_back(i);
     add_uncertainty(rd, tag, params, indices);
   ...
   void SubSpectrum::add_uncertainty_high(double rd, Par::Phys tag, std::vector<str>& params, int i)
   {
     std::vector<int> indices;
     indices.push_back(i);
     add_uncertainty_high(rd, tag, params, indices);
   ...
   void SubSpectrum::add_uncertainty_low(double rd, Par::Phys tag, std::vector<str>& params, int i)
   {
     std::vector<int> indices;
     indices.push_back(i);
     add_uncertainty_low(rd, tag, params, indices);
