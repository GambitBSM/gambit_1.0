...
class AbsoluteIsolationClassifier : public ExRootClassifier
{
public:

  AbsoluteIsolationClassifier() {}
...
Int_t AbsoluteIsolationClassifier::GetCategory(TObject *object)
{
...
{
  fClassifier = new AbsoluteIsolationClassifier;
}
...
void AbsoluteIsolation::Process()
{
