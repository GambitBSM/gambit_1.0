...
function(add_gambit_executable executablename LIBRARIES)
  ...
  if (GSL_FOUND)
    #Doesn't work yet
    if("${PREFERRED_MATH_LIBRARY}" STREQUAL "HDF5" AND HDF5_FOUND)					    
    #  string(REGEX REPLACE "[;^|^]+libm\\.[;^|$]+" "" GSL_LIBRARIES ${GSL_LIBRARIES}) 
    endif()                           
  ...
  if(HDF5_FOUND)
    #Doesn't work yet
    if("${PREFERRED_MATH_LIBRARY}" STREQUAL "GSL" AND GSL_FOUND)				    
    #  string(REGEX REPLACE "(^|\\..+)/.*libm\\..*(/|$)" "\\1\\2" HDF5_LIBRARIES ${HDF5_LIBRARIES}) 
    endif()                                                                         
