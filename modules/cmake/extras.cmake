...
if (${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
  set(pythia_CXX_SHARED_FLAGS "-stdlib=libstdc++ ${pythia_CXX_SHARED_FLAGS}")
endif()

ExternalProject_Add(pythia
  SOURCE_DIR ${PROJECT_SOURCE_DIR}/../extras/boss/bossed_pythia_source
  BUILD_IN_SOURCE 1
  CONFIGURE_COMMAND ./configure --enable-shared --cxx="${CMAKE_CXX_COMPILER}" --cxx-common="${pythia_CXXFLAGS}" --cxx-shared="${pythia_CXX_SHARED_FLAGS}" --lib-suffix=".so" ${pythia_CONFIGURE_EXTRAS}
  ...
  COMMAND echo "OSX DEBUG: pythia_CXX_SHARED_FLAGS = ${pythia_CXX_SHARED_FLAGS}"
  BUILD_COMMAND make
