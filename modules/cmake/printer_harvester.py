...
def main(argv):
    ...
    if verbose: print "Extra printer files identified:"
...
// Automatically-generated list of printers.      \n"
    ...
    candidate = build_dir+"/printer_rollcall.hpp.candidate"
