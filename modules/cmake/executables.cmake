...
if(EXISTS "${PROJECT_SOURCE_DIR}/Core/")
  ...
  if(MPI_FOUND)
    target_link_libraries(gambit ${MPI_C_LIBRARIES} ${MPI_EXTRA_LIBRARY})
    set_target_properties(gambit PROPERTIES LINK_FLAGS ${MPI_C_LINK_FLAGS})
  endif()
endif()
...
if(EXISTS "${PROJECT_SOURCE_DIR}/ScannerBit/")
  ...
  if(MPI_FOUND)
    target_link_libraries(ScannerBit_standalone ${MPI_C_LIBRARIES} ${MPI_EXTRA_LIBRARY})
    set_target_properties(ScannerBit_standalone PROPERTIES LINK_FLAGS ${MPI_C_LINK_FLAGS})
  endif()
endif()
