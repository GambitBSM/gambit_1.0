...
namespace Funk
{
    ...
    class FunkBase: public enable_shared_from_this<FunkBase>
    {
        public:
            ...
            virtual double value(std::vector<double> &, size_t bindID) = 0;
            ...
            virtual void resolve(std::map<std::string, size_t> datamap, size_t & datalen, size_t bindID);
    ...
    class FunkPlain: public FunkBase
    {
        public:
            ...
            double value(std::vector<double> & args, size_t bindID)
            { 
                (void)args;
                (void)bindID;
    ...
    class FunkConst: public FunkBase
    {
        public:
            ...
            double value(std::vector<double> & data, size_t bindID)
            {
                (void)data;
                (void)bindID;
                return c;
    ...
    class FunkDerived: public FunkBase
    {
        public:
            ...
            void resolve(std::map<std::string, size_t> datamap, size_t & datalen, size_t bindID)
            {
    ...
    inline void FunkBase::resolve(std::map<std::string, size_t> datamap, size_t & datalen, size_t bindID)
    {
