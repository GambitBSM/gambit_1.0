...
namespace Gambit {
  namespace ColliderBit {
    ...
    class OPALCharginoHadronicLimit : public BaseLimit {
      ...
      public:
        OPALCharginoHadronicLimit() {
          ...
          std::transform(corners.begin(), --corners.end(), ++corners.begin(),
                         contoursPointer->begin(), makeLine);
          _limitContours.insert(LimitContourEntry(1.0, contoursPointer));
    ...
    class OPALCharginoSemileptonicLimit : public BaseLimit {
      /// @name Types and Storage
      //@{
      public:
        static constexpr double confidenceLevel = 0.95;
    ...
    class OPALCharginoLeptonicLimit : public BaseLimit {
      /// @name Types and Storage
      //@{
      public:
        static constexpr double confidenceLevel = 0.95;
    ...
    class OPALCharginoAllChannelsLimit : public BaseLimit {
      /// @name Types and Storage
      //@{
      public:
        static constexpr double confidenceLevel = 0.95;
    ...
    class OPALNeutralinoHadronicLimit : public BaseLimit {
      /// @name Types and Storage
      //@{
      public:
        static constexpr double confidenceLevel = 0.95;
      ...
      public:
        OPALNeutralinoHadronicLimit() {
          ...
          _limitContours.insert(LimitContourEntry(0.15, contoursPointer));
          ...
          _limitContours.insert(LimitContourEntry(0.051, contoursPointer));
    ...
    /// @brief A class to contain the limit data from OPAL_EPJC35_2004_1, figure 9b.
    class OPALNeutralinoHadronicViaZLimit : public BaseLimit {
      /// @name Types and Storage
      //@{
      public:
        static constexpr double confidenceLevel = 0.95;
      ...
      public:
        ...
        bool isWithinExclusionRegion(double x, double y) {
          ...
          return (y <= x and x + y <= sqrtsGeV and x + y > 100. and !inHole);
        }
        /// @brief Return the limit value outside of the exclusion region
        double specialLimit(double x, double y) {
          /// @note Plot caption explicitly mentions 100 GeV, rather than the Z mass
      ...
      //@{
      public:
        OPALNeutralinoHadronicViaZLimit() {
          Corners corners;
          ContoursPointer contoursPointer;
          size_t oldSize;
