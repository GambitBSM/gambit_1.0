...
namespace Gambit {
  namespace ColliderBit {
    ...
    class L3ChargedGauginoSmallDeltaMWithHeavySneutrinoLimit : public BaseLimit {
      ...
      //@{
      public:
        L3ChargedGauginoSmallDeltaMWithHeavySneutrinoLimit() {
          Corners corners;
          ...
          _limitContours.insert(LimitContourEntry(6.0, contoursPointer));
          ...
          std::transform(corners.begin(), --corners.end(), ++corners.begin(),
                         contoursPointer->begin(), makeLine);
          _limitContours.insert(LimitContourEntry(4.0, contoursPointer));
    ...
    class L3ChargedGauginoSmallDeltaMAnySneutrinoLimit : public BaseLimit {
      /// @name Types and Storage
      //@{
      public:
        static const double confidenceLevel = 0.95;
      ...
      //@{
      public:
        L3ChargedGauginoSmallDeltaMAnySneutrinoLimit() {
          Corners corners;
          ContoursPointer contoursPointer;
    ...
    class L3ChargedHiggsinoSmallDeltaMLimit : public BaseLimit {
      /// @name Types and Storage
      //@{
      public:
        static const double confidenceLevel = 0.95;
      ...
      //@{
      public:
        L3ChargedHiggsinoSmallDeltaMLimit() {
          Corners corners;
          ContoursPointer contoursPointer;
