//
// File generated by rootcint at Wed Dec 17 20:09:52 2014
...
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::BTaggingWithTruth*)0x0)->GetClass();} }
   return fgIsA;
}
