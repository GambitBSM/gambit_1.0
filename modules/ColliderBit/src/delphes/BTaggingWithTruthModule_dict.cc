...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::BTaggingWithTruth*)
   {
      ::BTaggingWithTruth *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::BTaggingWithTruth >(0);
      static ::ROOT::TGenericClassInfo 
         instance("BTaggingWithTruth", ::BTaggingWithTruth::Class_Version(), "./../../include/delphes/BTaggingWithTruthModule.h", 29,
                  typeid(::BTaggingWithTruth), ::ROOT::DefineBehavior(ptr, ptr),
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::BTaggingWithTruth*)
   {
...
atomic_TClass_ptr BTaggingWithTruth::fgIsA(0);  // static to hold class pointer
...
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::BTaggingWithTruth*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int BTaggingWithTruth::ImplFileLine()
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::BTaggingWithTruth*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
void BTaggingWithTruth::Dictionary()
{
   fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::BTaggingWithTruth*)0x0)->GetClass();
}

//______________________________________________________________________________
TClass *BTaggingWithTruth::Class()
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::BTaggingWithTruth*)0x0)->GetClass();} }
   return fgIsA;
}
...
} // end of namespace ROOTDict for class ::BTaggingWithTruth
...
extern "C" void G__set_cpp_environmentBTaggingWithTruthModule_dict() {
  ...
  G__add_compiledheader("../../include/delphes/BTaggingWithTruthModule.h");
...
/* BTaggingWithTruth */
static int G__BTaggingWithTruthModule_dict_451_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BTaggingWithTruthModule_dict_451_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) BTaggingWithTruth::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BTaggingWithTruthModule_dict_451_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) BTaggingWithTruth::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BTaggingWithTruthModule_dict_451_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) BTaggingWithTruth::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BTaggingWithTruthModule_dict_451_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BTaggingWithTruthModule_dict_451_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BTaggingWithTruthModule_dict_451_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) BTaggingWithTruth::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BTaggingWithTruthModule_dict_451_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) BTaggingWithTruth::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BTaggingWithTruthModule_dict_451_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) BTaggingWithTruth::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BTaggingWithTruthModule_dict_451_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BTaggingWithTruthModule_dict_451_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__BTaggingWithTruthModule_dict_451_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static void G__setup_memvarBTaggingWithTruth(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__BTaggingWithTruthModule_dictLN_TClass),G__defined_typename("atomic_TClass_ptr"),-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncBTaggingWithTruth(void) {
   ...
   G__memfunc_setup("BTaggingWithTruth",1718,G__BTaggingWithTruthModule_dict_451_0_1, 105, G__get_linked_tagnum(&G__BTaggingWithTruthModule_dictLN_BTaggingWithTruth), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   ...
   G__memfunc_setup("Class",502,G__BTaggingWithTruthModule_dict_451_0_5, 85, G__get_linked_tagnum(&G__BTaggingWithTruthModule_dictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&BTaggingWithTruth::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__BTaggingWithTruthModule_dict_451_0_6, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&BTaggingWithTruth::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__BTaggingWithTruthModule_dict_451_0_7, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&BTaggingWithTruth::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__BTaggingWithTruthModule_dict_451_0_8, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&BTaggingWithTruth::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__BTaggingWithTruthModule_dict_451_0_12, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__BTaggingWithTruthModule_dict_451_0_13, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&BTaggingWithTruth::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__BTaggingWithTruthModule_dict_451_0_14, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&BTaggingWithTruth::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__BTaggingWithTruthModule_dict_451_0_15, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&BTaggingWithTruth::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__BTaggingWithTruthModule_dict_451_0_16, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&BTaggingWithTruth::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("BTaggingWithTruth", 1718, G__BTaggingWithTruthModule_dict_451_0_17, (int) ('i'), G__get_linked_tagnum(&G__BTaggingWithTruthModule_dictLN_BTaggingWithTruth), -1, 0, 1, 1, 1, 0, "u 'BTaggingWithTruth' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~BTaggingWithTruth", 1844, G__BTaggingWithTruthModule_dict_451_0_18, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
