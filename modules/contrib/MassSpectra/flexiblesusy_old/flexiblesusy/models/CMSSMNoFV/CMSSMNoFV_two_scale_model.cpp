 ...
 * parameters.
 *
 * This file was generated at Wed 3 Dec 2014 13:16:08 with FlexibleSUSY
...
int CLASSNAME::tadpole_equations(const gsl_vector* x, void* params, gsl_vector* f)
{
   ...
   CMSSMNoFV* model = ewsb_parameters->model;
...
void CLASSNAME::calculate_MVZ()
{
   ...
   problems.flag_tachyon(CMSSMNoFV_info::VZ, MVZ < 0.);
...
{
   MFd = 0.7071067811865475*vd*Yd(0,0);
}

void CLASSNAME::calculate_MFs()
{
   MFs = 0.7071067811865475*vd*Yd(1,1);
}

void CLASSNAME::calculate_MFb()
{
   MFb = 0.7071067811865475*vd*Yd(2,2);
}

void CLASSNAME::calculate_MFu()
{
   MFu = 0.7071067811865475*vu*Yu(0,0);
}

void CLASSNAME::calculate_MFc()
{
   MFc = 0.7071067811865475*vu*Yu(1,1);
}

void CLASSNAME::calculate_MFt()
{
   MFt = 0.7071067811865475*vu*Yu(2,2);
}
...
{
   MFe = 0.7071067811865475*vd*Ye(0,0);
}

void CLASSNAME::calculate_MFm()
{
   MFm = 0.7071067811865475*vd*Ye(1,1);
}

void CLASSNAME::calculate_MFtau()
{
   MFtau = 0.7071067811865475*vd*Ye(2,2);
}
...
void CLASSNAME::calculate_MSveL()
{
   ...
   problems.flag_tachyon(CMSSMNoFV_info::SveL, MSveL < 0.);
...
void CLASSNAME::calculate_MSvmL()
{
   ...
   problems.flag_tachyon(CMSSMNoFV_info::SvmL, MSvmL < 0.);
...
void CLASSNAME::calculate_MSvtL()
{
   ...
   problems.flag_tachyon(CMSSMNoFV_info::SvtL, MSvtL < 0.);
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_tachyon(CMSSMNoFV_info::Sd, MSd.minCoeff() < 0.);
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_tachyon(CMSSMNoFV_info::Su, MSu.minCoeff() < 0.);
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_tachyon(CMSSMNoFV_info::Se, MSe.minCoeff() < 0.);
...
void CLASSNAME::calculate_MSm()
{
   ...
   problems.flag_tachyon(CMSSMNoFV_info::Sm, MSm.minCoeff() < 0.);
...
void CLASSNAME::calculate_MStau()
{
   ...
   problems.flag_tachyon(CMSSMNoFV_info::Stau, MStau.minCoeff() < 0.);
...
void CLASSNAME::calculate_MSs()
{
   ...
   problems.flag_tachyon(CMSSMNoFV_info::Ss, MSs.minCoeff() < 0.);
...
void CLASSNAME::calculate_MSc()
{
   ...
   problems.flag_tachyon(CMSSMNoFV_info::Sc, MSc.minCoeff() < 0.);
...
void CLASSNAME::calculate_MSb()
{
   ...
   problems.flag_tachyon(CMSSMNoFV_info::Sb, MSb.minCoeff() < 0.);
...
void CLASSNAME::calculate_MSt()
{
   ...
   problems.flag_tachyon(CMSSMNoFV_info::St, MSt.minCoeff() < 0.);
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_tachyon(CMSSMNoFV_info::hh, Mhh.minCoeff() < 0.);
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_tachyon(CMSSMNoFV_info::Ah, MAh.minCoeff() < 0.);
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_tachyon(CMSSMNoFV_info::Hpm, MHpm.minCoeff() < 0.);
...
void CLASSNAME::calculate_MVWm()
{
   ...
   problems.flag_tachyon(CMSSMNoFV_info::VWm, MVWm < 0.);
...
void CLASSNAME::calculate_Mhh_3rd_generation(double& msf1, double& msf2, double& theta) const {
   sfermions::Mass_data sf_data;
   sf_data.ml2 = ml2(2,2);
   sf_data.mr2 = 0.;
   sf_data.yf  = 0.;
...
void CLASSNAME::calculate_MHpm_3rd_generation(double& msf1, double& msf2, double& theta) const {
   sfermions::Mass_data sf_data;
   sf_data.ml2 = ml2(2,2);
   sf_data.mr2 = me2(2,2);
   sf_data.yf  = Ye(2,2);
...
void CLASSNAME::self_energy_hh_2loop(double result[3]) const
{
   ...
   calculate_MHpm_3rd_generation(mstau_1, mstau_2, theta_tau);
   calculate_Mhh_3rd_generation(msnu_1, msnu_2, theta_nu);
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   PHYSICAL(MFd) = MFd - self_energy_1 - MFd * (self_energy_PL +
      self_energy_PR);
}
...
void CLASSNAME::calculate_MFs_pole()
{
   ...
   PHYSICAL(MFs) = MFs - self_energy_1 - MFs * (self_energy_PL +
      self_energy_PR);
}
...
void CLASSNAME::calculate_MFb_pole()
{
   ...
   PHYSICAL(MFb) = MFb - self_energy_1 - MFb * (self_energy_PL +
      self_energy_PR);
}
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   PHYSICAL(MFu) = MFu - self_energy_1 - MFu * (self_energy_PL +
      self_energy_PR);
}
...
void CLASSNAME::calculate_MFc_pole()
{
   ...
   PHYSICAL(MFc) = MFc - self_energy_1 - MFc * (self_energy_PL +
      self_energy_PR);
}
...
void CLASSNAME::calculate_MFt_pole()
{
   ...
   PHYSICAL(MFt) = MFt - self_energy_1 - MFt * (self_energy_PL +
      self_energy_PR);
}
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   PHYSICAL(MFe) = MFe - self_energy_1 - MFe * (self_energy_PL +
      self_energy_PR);
}
...
void CLASSNAME::calculate_MFm_pole()
{
   ...
   PHYSICAL(MFm) = MFm - self_energy_1 - MFm * (self_energy_PL +
      self_energy_PR);
}
...
void CLASSNAME::calculate_MFtau_pole()
{
   ...
   PHYSICAL(MFtau) = MFtau - self_energy_1 - MFtau * (self_energy_PL +
      self_energy_PR);
}
...
void CLASSNAME::calculate_MSveL_pole()
{
   ...
   const double mass_sqr = Sqr(MSveL) - self_energy;
...
void CLASSNAME::calculate_MSvmL_pole()
{
   ...
   const double mass_sqr = Sqr(MSvmL) - self_energy;
...
void CLASSNAME::calculate_MSvtL_pole()
{
   ...
   const double mass_sqr = Sqr(MSvtL) - self_energy;
