...
public:
   ...
   template <class T> void set_extra(const MSSMNoFV_slha<T>&);
   ...
   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const MSSMNoFV_slha<T>&, const QedQcd& qedqcd);

   template <class T>
   static SLHAea::Coll fill_slhaea(const MSSMNoFV_slha<T>&, const QedQcd& qedqcd);
...
template <class T>
void MSSMNoFV_slha_io::fill_slhaea(SLHAea::Coll& slhaea, const MSSMNoFV_slha<T>& model, const QedQcd& qedqcd)
{
...
template <class T>
SLHAea::Coll MSSMNoFV_slha_io::fill_slhaea(const MSSMNoFV_slha<T>& model, const QedQcd& qedqcd)
{
   SLHAea::Coll slhaea;
   MSSMNoFV_slha_io::fill_slhaea(slhaea, model, qedqcd);
 ...
 */
template <class T>
void MSSMNoFV_slha_io::set_extra(const MSSMNoFV_slha<T>& model)
{
