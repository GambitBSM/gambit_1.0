 ...
 * parameters.
 *
 * This file was generated at Thu 4 Dec 2014 21:45:33 with FlexibleSUSY
...
int CLASSNAME::tadpole_equations(const gsl_vector* x, void* params, gsl_vector* f)
{
   ...
   NUHMSSM* model = ewsb_parameters->model;
...
void CLASSNAME::calculate_MVZ()
{
   ...
   problems.flag_tachyon(NUHMSSM_info::VZ, MVZ < 0.);
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_tachyon(NUHMSSM_info::Sd, MSd.minCoeff() < 0.);
...
void CLASSNAME::calculate_MSv()
{
   ...
   problems.flag_tachyon(NUHMSSM_info::Sv, MSv.minCoeff() < 0.);
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_tachyon(NUHMSSM_info::Su, MSu.minCoeff() < 0.);
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_tachyon(NUHMSSM_info::Se, MSe.minCoeff() < 0.);
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_tachyon(NUHMSSM_info::hh, Mhh.minCoeff() < 0.);
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_tachyon(NUHMSSM_info::Ah, MAh.minCoeff() < 0.);
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_tachyon(NUHMSSM_info::Hpm, MHpm.minCoeff() < 0.);
...
void CLASSNAME::calculate_MVWm()
{
   ...
   problems.flag_tachyon(NUHMSSM_info::VWm, MVWm < 0.);
