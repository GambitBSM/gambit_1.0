...
template<>
class NSM_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   NSM_low_scale_constraint();
   NSM_low_scale_constraint(NSM<Two_scale>*, const QedQcd&);
   virtual ~NSM_low_scale_constraint();
   virtual void apply();
