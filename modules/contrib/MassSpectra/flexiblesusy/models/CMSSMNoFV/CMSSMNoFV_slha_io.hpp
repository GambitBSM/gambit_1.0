...
public:
   ...
   template <class T> void set_extra(const CMSSMNoFV_slha<T>&);
   ...
   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const CMSSMNoFV_slha<T>&, const QedQcd& qedqcd);

   template <class T>
   static SLHAea::Coll fill_slhaea(const CMSSMNoFV_slha<T>&, const QedQcd& qedqcd);
...
template <class T>
void CMSSMNoFV_slha_io::fill_slhaea(SLHAea::Coll& slhaea, const CMSSMNoFV_slha<T>& model, const QedQcd& qedqcd)
{
...
template <class T>
SLHAea::Coll CMSSMNoFV_slha_io::fill_slhaea(const CMSSMNoFV_slha<T>& model, const QedQcd& qedqcd)
{
   SLHAea::Coll slhaea;
   CMSSMNoFV_slha_io::fill_slhaea(slhaea, model, qedqcd);
 ...
 */
template <class T>
void CMSSMNoFV_slha_io::set_extra(const CMSSMNoFV_slha<T>& model)
{
