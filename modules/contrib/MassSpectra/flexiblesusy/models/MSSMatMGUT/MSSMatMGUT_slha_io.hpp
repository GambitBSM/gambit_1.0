...
// File generated at Wed 3 Dec 2014 11:34:51
...
public:
   ...
   template <class T> void set_extra(const MSSMatMGUT_slha<T>&);
   ...
   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const MSSMatMGUT_slha<T>&, const QedQcd& qedqcd);

   template <class T>
   static SLHAea::Coll fill_slhaea(const MSSMatMGUT_slha<T>&, const QedQcd& qedqcd);
...
template <class T>
void MSSMatMGUT_slha_io::fill_slhaea(SLHAea::Coll& slhaea, const MSSMatMGUT_slha<T>& model, const QedQcd& qedqcd)
{
...
template <class T>
SLHAea::Coll MSSMatMGUT_slha_io::fill_slhaea(const MSSMatMGUT_slha<T>& model, const QedQcd& qedqcd)
{
   SLHAea::Coll slhaea;
   MSSMatMGUT_slha_io::fill_slhaea(slhaea, model, qedqcd);
 ...
 */
template <class T>
void MSSMatMGUT_slha_io::set_extra(const MSSMatMGUT_slha<T>& model)
{
