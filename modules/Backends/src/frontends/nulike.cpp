...
BE_INI_FUNCTION
{
  ...
  if (scan_level)
  {
    ...
    if (*InUse::nulike_bounds)
    {
      ...
      char eventf_79WL[clen], BGf_79WL[clen], efareaf_79WL[clen], partiald_79WL[clen];
      ...
      nulike_init(experiment_79WL[0], eventf_79WL[0], BGf_79WL[0], efareaf_79WL[0], partiald_79WL[0], 
                  phi_cut22, uselogNorm, BGLikePrecompute);
      ...
      char eventf_79SL[clen], BGf_79SL[clen], efareaf_79SL[clen], partiald_79SL[clen];
      ...
      nulike_init(experiment_79SL[0], eventf_79SL[0], BGf_79SL[0], efareaf_79SL[0], partiald_79SL[0], 
                  phi_cut22, uselogNorm, BGLikePrecompute);
