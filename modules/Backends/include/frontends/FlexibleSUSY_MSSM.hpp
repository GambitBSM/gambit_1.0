...
///  \file
///
///  Fronted header for the FlexibleSUSY generated
///  MSSM spectrum generator backend.
///
///  All the functions in here are actually
///  convenience functions, since due to the object
///  structure of FlexibleSUSY we create and fill
///  the objects here.
///
///  *********************************************
///
...
#else
  #define BACKENDNAME FlexibleSUSY_MSSM
#endif
#define VERSION 0.1
