#ifndef __wrapper_SLHAinterface_def_Pythia_8_186_h__
#define __wrapper_SLHAinterface_def_Pythia_8_186_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
    ...
    namespace Pythia8
    {
        ...
        inline void SLHAinterface::init(WrapperBase< Pythia8::Abstract_Settings >& settings, WrapperBase< Pythia8::Abstract_Rndm >* rndmPtr, WrapperBase< Pythia8::Abstract_Couplings >* couplingsPtrIn, WrapperBase< Pythia8::Abstract_ParticleData >* particleDataPtr, bool& useSHLAcouplings)
        {
            wrapperbase::BEptr->init__BOSS(*settings.BEptr, (*rndmPtr).BEptr, (*couplingsPtrIn).BEptr, (*particleDataPtr).BEptr, useSHLAcouplings);
        }
...
#endif /* __wrapper_SLHAinterface_def_Pythia_8_186_h__ */
