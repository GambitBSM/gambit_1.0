#ifndef __wrapper_CoupSUSY_def_Pythia_8_186_h__
#define __wrapper_CoupSUSY_def_Pythia_8_186_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
    ...
    namespace Pythia8
    {
        ...
        inline std::basic_string<char,std::char_traits<char>,std::allocator<char> > CoupSUSY::getName(int pdgCode)
        {
            return wrapperbase::BEptr->getName(pdgCode);
        }
...
#endif /* __wrapper_CoupSUSY_def_Pythia_8_186_h__ */
