#ifndef __abstract_Settings_Pythia_8_186_h__
#define __abstract_Settings_Pythia_8_186_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
    ...
    namespace Pythia8
    {
        ...
        {
            private:
                // IGNORED: Field  -- Name: infoPtr  -- XML id: _22593
                // IGNORED: Field  -- Name: flags  -- XML id: _22594
                // IGNORED: Field  -- Name: modes  -- XML id: _22595
                // IGNORED: Field  -- Name: parms  -- XML id: _22596
                // IGNORED: Field  -- Name: words  -- XML id: _22597
                // IGNORED: Field  -- Name: fvecs  -- XML id: _22598
                // IGNORED: Field  -- Name: mvecs  -- XML id: _22599
                // IGNORED: Field  -- Name: pvecs  -- XML id: _22600
                // IGNORED: Field  -- Name: isInit  -- XML id: _22601
                // IGNORED: Field  -- Name: readingFailedSave  -- XML id: _22602
            public:
                ...
                virtual void addMode(std::basic_string<char,std::char_traits<char>,std::allocator<char> >, int, bool, bool, int, int) =0;
                ...
                virtual void mode(std::basic_string<char,std::char_traits<char>,std::allocator<char> >, int) =0;
...
#endif /* __abstract_Settings_Pythia_8_186_h__ */
