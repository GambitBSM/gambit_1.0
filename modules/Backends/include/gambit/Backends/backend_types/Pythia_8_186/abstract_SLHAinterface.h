#ifndef __abstract_SLHAinterface_Pythia_8_186_h__
#define __abstract_SLHAinterface_Pythia_8_186_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
    ...
    namespace Pythia8
    {
        ...
        {
            public:
                // IGNORED: Field  -- Name: slha  -- XML id: _23783
    
                virtual Pythia8::Abstract_CoupSUSY& coupSUSY_ref__BOSS() =0;
                // IGNORED: Field  -- Name: couplingsPtr  -- XML id: _23785
                // IGNORED: Field  -- Name: infoPtr  -- XML id: _23786
                // IGNORED: Field  -- Name: settingsPtr  -- XML id: _23787
    
                virtual int& meMode_ref__BOSS() =0;
    
                virtual void setPtr__BOSS(Pythia8::Abstract_Info*) =0;
    
                virtual void init__BOSS(Pythia8::Abstract_Settings&, Pythia8::Abstract_Rndm*, Pythia8::Abstract_Couplings*, Pythia8::Abstract_ParticleData*, bool&) =0;
...
#endif /* __abstract_SLHAinterface_Pythia_8_186_h__ */
