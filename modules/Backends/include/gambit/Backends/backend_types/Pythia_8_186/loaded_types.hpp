...
#define Pythia_8_186_all_data \
  ...
  (( /*class*/(Pythia8)(AlphaStrong),    /*constructors*/(("_ZN7Pythia821Factory_AlphaStrong_0Ev",())) (("_ZN7Pythia821Factory_AlphaStrong_1Edi",(double, int))) (("_ZN7Pythia821Factory_AlphaStrong_2Ed",(double))) )) \
