...
namespace Gambit
{
    ...
    namespace Pythia8
    {
        ...
        // Typedefs for GAMBIT
        typedef Abstract__Particle Particle;
        typedef Abstract__ParticleData ParticleData;
        typedef Abstract__Vec4 Vec4;
        typedef Abstract__RotBstMatrix RotBstMatrix;
        typedef Abstract__Event Event;
        typedef Abstract__Pythia Pythia;
