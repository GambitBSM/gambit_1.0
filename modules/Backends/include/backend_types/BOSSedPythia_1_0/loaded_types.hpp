#ifndef __loaded_types_BOSSedPythia_1_0_hpp__
#define __loaded_types_BOSSedPythia_1_0_hpp__ 1
...
#define BOSSedPythia_1_0_all_data \
  ...
  (( /*class*/(Pythia8)(Hist),      /*constructors*/(("_ZN7Pythia812Factory_HistEv",())) (("_ZN7Pythia812Factory_HistESsidd",(std::string,int,double,double))) (("_ZN7Pythia812Factory_HistESsid",(std::string,int,double))) (("_ZN7Pythia812Factory_HistESsi",(std::string,int))) (("_ZN7Pythia812Factory_HistESs",(std::string))) (("_ZN7Pythia812Factory_HistESsRKN16BOSSedPythia_1_07Pythia84HistE",(std::string,const my_ns::Pythia8::Hist&))) )) \
...
#endif /* __loaded_types_BOSSedPythia_1_0_hpp__ */
