...
//TB: this only initializes DarkSUSY, so it should get a new name...
  START_CAPABILITY
...
//TB: placeholder, see comment in DarkBit.cpp  
  START_CAPABILITY
...
//TB: What is this doing?? Should be obsolte now that the RD routines
//are fully working...!
      START_FUNCTION(double)
