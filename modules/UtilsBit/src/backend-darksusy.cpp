/* Backend for DarkSUSY. I have no idea if any of this works because
 * I don't have a shared DarkSUSY library to link against... But it's a
 * start. This is liberally copied from the GAMBIT Herwig Backend.
