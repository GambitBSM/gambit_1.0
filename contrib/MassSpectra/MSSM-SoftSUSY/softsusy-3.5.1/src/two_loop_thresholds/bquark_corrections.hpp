...
#ifndef _BQUARK_CORRECTIONS_H
#define _BQUARK_CORRECTIONS_H
//#include "config.h"
...
namespace bquark_corrections {
	...
	GiNaC::ex eval_bquark_twoloop_yukawa_dec(const GiNaC::exmap &params);
        GiNaC::ex eval_bquark_twoloop_strong_dec(const GiNaC::exmap &params);
}
