...
// File generated at Wed 28 Oct 2015 11:35:48
 ...
 */
Eigen::Matrix<double,3,3> SSM_susy_parameters::calc_beta_Yu_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> SSM_susy_parameters::calc_beta_Yu_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Yu = (twoLoop*(0.0016666666666666668*Yu*(1187*Power(g1,4) - 3450*
      ...
      g1) + 9*Sqr(g2) + 32*Sqr(g3)) + 150*Sqr(K2) + 900*Sqr(Lambdax)) + 0.0125*
      ((300*traceYdAdjYd + 100*traceYeAdjYe + 300*traceYuAdjYu - 43*Sqr(g1) +
      45*Sqr(g2) - 1280*Sqr(g3))*(Yu*Yd.adjoint()*Yd) + (-540*traceYdAdjYd -
      180*traceYeAdjYe - 540*traceYuAdjYu - 480*Lambdax + 223*Sqr(g1) + 675*Sqr
      (g2) + 1280*Sqr(g3))*(Yu*Yu.adjoint()*Yu) + 20*(11*(Yu*Yd.adjoint()*Yd*
 ...
 */
Eigen::Matrix<double,3,3> SSM_susy_parameters::calc_beta_Yu_three_loop(const Susy_traces& susy_traces) const
{
