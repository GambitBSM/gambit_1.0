...
double SSM_soft_parameters::calc_beta_K1_one_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_K1 = Re(oneOver16PiSqr*(4*K1*K2 + 6*K1*traceYdAdjYd + 2*K1*
      traceYeAdjYe + 6*K1*traceYuAdjYu + 6*K1*Lambdax - 0.9*K1*Sqr(g1) - 4.5*K1
      *Sqr(g2)));
...
double SSM_soft_parameters::calc_beta_K1_two_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_K1 = Re(twoLoop*(4.1775*Power(g1,4)*K1 - 9.0625*Power(g2,4)*K1 -
      ...
      - 13.5*K1*traceYuAdjYuYuAdjYu - 36*K1*K2*Lambdax - 36*K1*traceYuAdjYu*
      Lambdax + 0.6*K1*K2*Sqr(g1) + 4.25*K1*traceYuAdjYu*Sqr(g1) + 7.2*K1*
      Lambdax*Sqr(g1) + 3*K1*K2*Sqr(g2) + 11.25*K1*traceYuAdjYu*Sqr(g2) + 36*K1
      *Lambdax*Sqr(g2) + 1.125*K1*Sqr(g1)*Sqr(g2) + 0.25*K1*traceYeAdjYe*(-16*(
      K2 + 3*Lambdax) + 15*Sqr(g1) + 15*Sqr(g2)) + 40*K1*traceYuAdjYu*Sqr(g3) +
      0.25*K1*traceYdAdjYd*(5*Sqr(g1) + 45*Sqr(g2) + 16*(-3*K2 - 9*Lambdax +
      10*Sqr(g3))) - 11.5*K1*Sqr(K2) + 12*K1*Sqr(LambdaS) - 15*K1*Sqr(Lambdax))
      );
