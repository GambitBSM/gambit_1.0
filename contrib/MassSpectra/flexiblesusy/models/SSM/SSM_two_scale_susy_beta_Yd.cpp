 ...
 */
Eigen::Matrix<double,3,3> SSM_susy_parameters::calc_beta_Yd_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> SSM_susy_parameters::calc_beta_Yd_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Yd = (twoLoop*(Yd*(-0.21166666666666667*Power(g1,4) - 5.75*Power(
      ...
      *Sqr(g2) + 1.875*traceYeAdjYe*(Sqr(g1) + Sqr(g2)) + 20*traceYuAdjYu*Sqr(
      ...
      traceYdAdjYd*(Sqr(g1) + 9*Sqr(g2) + 32*Sqr(g3)) + 0.25*Sqr(K2) + 1.5*Sqr(
      Lambdax)) + 0.0125*((-540*traceYdAdjYd - 180*traceYeAdjYe - 540*
 ...
 */
Eigen::Matrix<double,3,3> SSM_susy_parameters::calc_beta_Yd_three_loop(const Susy_traces& susy_traces) const
{
