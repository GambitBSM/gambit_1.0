...
SSM_spectrum_plotter::SSM_spectrum_plotter()
   : spectrum()
   , scale(0.0)
   , width(16)
{
   ...
   const SSM_observables* observables)
{
   ...
   append(names, SSM_parameter_getter().get_mass_names());
   append(names, SSM_parameter_getter().get_mixing_names());
   ...
   Physical_input* physical_input, SSM_observables* observables)
{
   ...
   const std::size_t number_of_masses = SSM_parameter_getter().get_number_of_masses();
   const std::size_t number_of_mixings = SSM_info::NUMBER_OF_MIXINGS;
   const std::size_t number_of_input_parameters = SSM_info::NUMBER_OF_INPUT_PARAMETERS;
   ...
   const std::size_t number_of_observables =
      (observables ? SSM_observables::NUMBER_OF_OBSERVABLES : 0u);
