...
CLASSNAME::SingletDMZ3_mass_eigenstates(const SingletDMZ3_input_parameters& input_)
   ...
   , physical()
   , problems(SingletDMZ3_info::particle_names)
...
CLASSNAME::~SingletDMZ3_mass_eigenstates()
{
}
...
const Problems<SingletDMZ3_info::NUMBER_OF_PARTICLES>& CLASSNAME::get_problems() const
{
   return problems;
}

Problems<SingletDMZ3_info::NUMBER_OF_PARTICLES>& CLASSNAME::get_problems()
{
   return problems;
}
...
int CLASSNAME::tadpole_equations(const gsl_vector* x, void* params, gsl_vector* f)
{
   ...
   SingletDMZ3_mass_eigenstates* model = ewsb_args->model;
...
void CLASSNAME::calculate_MHp()
{
   ...
   if (MHp < 0.) {
      problems.flag_tachyon(SingletDMZ3_info::Hp);
   }
...
void CLASSNAME::calculate_Mss()
{
   ...
   if (Mss < 0.) {
      problems.flag_tachyon(SingletDMZ3_info::ss);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   if (MAh < 0.) {
      problems.flag_tachyon(SingletDMZ3_info::Ah);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   if (Mhh < 0.) {
      problems.flag_tachyon(SingletDMZ3_info::hh);
   }
...
void CLASSNAME::calculate_MVWp()
{
   ...
   if (MVWp < 0.) {
      problems.flag_tachyon(SingletDMZ3_info::VWp);
   }
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   do {
      ...
      const double qcd_1l = -0.008443431970194815*(4. - 3.*Log(Sqr(MFu
         (2))/Sqr(currentScale)))*Sqr(g3);
