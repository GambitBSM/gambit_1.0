...
void SingletDMZ3_effective_couplings::run_SM_strong_coupling_to(double m)
{
...
std::complex<double> SingletDMZ3_effective_couplings::CpFdhhbarFdPL(unsigned gt1, unsigned gt3) const
{
...
std::complex<double> SingletDMZ3_effective_couplings::CpFuhhbarFuPL(unsigned gt1, unsigned gt3) const
{
...
std::complex<double> SingletDMZ3_effective_couplings::CpFehhbarFePL(unsigned gt1, unsigned gt3) const
{
...
double SingletDMZ3_effective_couplings::CphhVWpconjVWp() const
{
...
std::complex<double> SingletDMZ3_effective_couplings::CpAhFdbarFdPL(unsigned gt2, unsigned gt3) const
{
   const auto Yd = MODELPARAMETER(Yd);
...
std::complex<double> SingletDMZ3_effective_couplings::CpAhFubarFuPL(unsigned gt2, unsigned gt3) const
{
   const auto Yu = MODELPARAMETER(Yu);
...
std::complex<double> SingletDMZ3_effective_couplings::CpAhFebarFePL(unsigned gt2, unsigned gt3) const
{
   const auto Ye = MODELPARAMETER(Ye);
