...
SingletDMZ3_convergence_tester<Two_scale>::SingletDMZ3_convergence_tester(SingletDMZ3<Two_scale>* model, double accuracy_goal)
   : Convergence_tester_DRbar<SingletDMZ3<Two_scale> >(model, accuracy_goal)
{
}
...
double SingletDMZ3_convergence_tester<Two_scale>::max_rel_diff() const
{
   ...
   const SingletDMZ3<Two_scale>& ne = get_model();
