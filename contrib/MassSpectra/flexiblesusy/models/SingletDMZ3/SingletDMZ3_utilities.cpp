...
SingletDMZ3_spectrum_plotter::SingletDMZ3_spectrum_plotter()
   : spectrum()
   , scale(0.0)
   , width(16)
{
   ...
   const SingletDMZ3_observables* observables)
{
   ...
   append(names, SingletDMZ3_parameter_getter().get_mass_names());
   append(names, SingletDMZ3_parameter_getter().get_mixing_names());
   ...
   Physical_input* physical_input, SingletDMZ3_observables* observables)
{
   ...
   const std::size_t number_of_masses = SingletDMZ3_parameter_getter().get_number_of_masses();
   const std::size_t number_of_mixings = SingletDMZ3_info::NUMBER_OF_MIXINGS;
   const std::size_t number_of_input_parameters = SingletDMZ3_info::NUMBER_OF_INPUT_PARAMETERS;
   ...
   const std::size_t number_of_observables =
      (observables ? SingletDMZ3_observables::NUMBER_OF_OBSERVABLES : 0u);
