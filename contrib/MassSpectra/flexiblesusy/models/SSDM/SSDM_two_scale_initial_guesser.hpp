...
#include "SSDM_initial_guesser.hpp"
...
/**
 * @class SSDM_initial_guesser<Two_scale>
 * @brief initial guesser for the SSDM
 */
...
private:
   ...
   SSDM_low_scale_constraint<Two_scale> low_constraint;
   SSDM_susy_scale_constraint<Two_scale> susy_constraint;
   SSDM_high_scale_constraint<Two_scale> high_constraint;
