...
// File generated at Fri 28 Aug 2015 18:02:16
...
#define CLASSNAME SSDM_susy_parameters
...
Eigen::ArrayXd SSDM_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

SSDM_susy_parameters SSDM_susy_parameters::calc_beta() const
{
...
void SSDM_susy_parameters::print(std::ostream& ostr) const
{
...
void SSDM_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   g1 = pars(0);
   g2 = pars(1);
   g3 = pars(2);
...
const SSDM_input_parameters& SSDM_susy_parameters::get_input() const
{
   return input;
}

SSDM_input_parameters& SSDM_susy_parameters::get_input()
{
   return input;
}

void SSDM_susy_parameters::set_input_parameters(const SSDM_input_parameters& input_)
{
   input = input_;
}

void SSDM_susy_parameters::calc_susy_traces(Susy_traces& susy_traces) const
{
...
std::ostream& operator<<(std::ostream& ostr, const SSDM_susy_parameters& susy_pars)
{
