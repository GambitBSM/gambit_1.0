...
#include "SSDM_convergence_tester.hpp"
...
template<>
class SSDM_convergence_tester<Two_scale> : public Convergence_tester_DRbar<SSDM<Two_scale> > {
public:
   SSDM_convergence_tester(SSDM<Two_scale>*, double);
   virtual ~SSDM_convergence_tester();
