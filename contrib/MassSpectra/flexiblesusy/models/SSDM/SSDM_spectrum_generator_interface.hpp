...
#ifndef SSDM_SPECTRUM_GENERATOR_INTERFACE_H
#define SSDM_SPECTRUM_GENERATOR_INTERFACE_H
...
template <class T>
class SSDM_spectrum_generator_interface {
public:
   SSDM_spectrum_generator_interface()
      : model()
      ...
      , force_output(false)
   {}
   virtual ~SSDM_spectrum_generator_interface() {}
   ...
   virtual void run(const softsusy::QedQcd&, const SSDM_input_parameters&) = 0;
 ...
 */
template <class T>
void SSDM_spectrum_generator_interface<T>::set_settings(
 ...
 */
template <class T>
void SSDM_spectrum_generator_interface<T>::write_running_couplings(
   const std::string& filename,
   double start, double stop) const
{
   SSDM_mass_eigenstates tmp_model(model);
   try {
   ...
   Coupling_monitor<SSDM_mass_eigenstates, SSDM_parameter_getter>
 ...
 */
template <class T>
void SSDM_spectrum_generator_interface<T>::write_spectrum(const std::string& filename) const
{
