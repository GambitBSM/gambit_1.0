...
class EWSB_solver;
/**
 * @class SSDM_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class SSDM_mass_eigenstates : public SSDM_soft_parameters {
public:
   explicit SSDM_mass_eigenstates(const SSDM_input_parameters& input_ = SSDM_input_parameters());
   virtual ~SSDM_mass_eigenstates();
   ...
   const SSDM_physical& get_physical() const;
   SSDM_physical& get_physical();
   const Problems<SSDM_info::NUMBER_OF_PARTICLES>& get_problems() const;
   Problems<SSDM_info::NUMBER_OF_PARTICLES>& get_problems();
...
private:
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(SSDM_mass_eigenstates::*Memfun_t)();
      SSDM_mass_eigenstates* model;
      Memfun_t fun;

      Thread(SSDM_mass_eigenstates* model_, Memfun_t fun_)
   ...
   SSDM_physical physical; ///< contains the pole masses and mixings
   Problems<SSDM_info::NUMBER_OF_PARTICLES> problems;
...
std::ostream& operator<<(std::ostream&, const SSDM_mass_eigenstates&);
