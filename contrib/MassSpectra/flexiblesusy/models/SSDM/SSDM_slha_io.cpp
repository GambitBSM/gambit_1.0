...
char const * const SSDM_slha_io::drbar_blocks[NUMBER_OF_DRBAR_BLOCKS] =
   { "gauge", "Yu", "Yd", "Ye", "HMIX", "SM", "MSOFT", "HDM" }
;

SSDM_slha_io::SSDM_slha_io()
   : slha_io()
{
}

void SSDM_slha_io::clear()
{
   slha_io.clear();
}
 ...
 */
void SSDM_slha_io::set_extpar(const SSDM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void SSDM_slha_io::set_minpar(const SSDM_input_parameters& input)
{
 ...
 */
void SSDM_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void SSDM_slha_io::set_spinfo(const Problems<SSDM_info::NUMBER_OF_PARTICLES>& problems)
{
 ...
 */
void SSDM_slha_io::set_mass(const SSDM_physical& physical,
 ...
 */
void SSDM_slha_io::set_mixing_matrices(const SSDM_physical& physical,
 ...
 */
void SSDM_slha_io::write_to_file(const std::string& file_name)
{
 ...
 */
double SSDM_slha_io::get_parameter_output_scale() const
{
 ...
 * @param file_name file name
 */
void SSDM_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void SSDM_slha_io::fill(SSDM_input_parameters& input) const
{
   SLHA_io::Tuple_processor minpar_processor
      = boost::bind(&SSDM_slha_io::fill_minpar_tuple, boost::ref(input), _1, _2);
   SLHA_io::Tuple_processor extpar_processor
      = boost::bind(&SSDM_slha_io::fill_extpar_tuple, boost::ref(input), _1, _2);
 ...
 */
void SSDM_slha_io::fill_drbar_parameters(SSDM_mass_eigenstates& model) const
{
 ...
 */
void SSDM_slha_io::fill(SSDM_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   SSDM_physical physical_hk;
...
void SSDM_slha_io::fill_extpar_tuple(SSDM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void SSDM_slha_io::fill_physical(SSDM_physical& physical) const
{
   {
 ...
 */
double SSDM_slha_io::read_scale() const
{
   double scale = 0.;
