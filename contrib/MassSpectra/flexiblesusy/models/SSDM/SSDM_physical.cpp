...
SSDM_physical::SSDM_physical()
   :
    MVG(0), MHp(0), Mss(0), MFv(Eigen::Array<double,3,1>::Zero()), MAh(0), Mhh
       (0), MVP(0), MVZ(0), MFd(Eigen::Array<double,3,1>::Zero()), MFu(
...
Eigen::ArrayXd SSDM_physical::get() const
{
   Eigen::ArrayXd pars(get_masses());

   pars.conservativeResize(128);
...
void SSDM_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd SSDM_physical::get_masses() const
{
...
void SSDM_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MHp = pars(1);
   Mss = pars(2);
