 ...
 */
double SCDM_soft_parameters::calc_beta_v_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double SCDM_soft_parameters::calc_beta_v_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_v = Re(-0.00125*twoLoop*v*(1257*Power(g1,4) - 8575*Power(g2,4) -
      ...
      Sqr(g1) + 315*Sqr(g2) + 800*Sqr(g3)) + 1200*Sqr(Lambda1) + 400*Sqr(LamSH)
      ));
 ...
 */
double SCDM_soft_parameters::calc_beta_v_three_loop(const Soft_traces& soft_traces) const
{
