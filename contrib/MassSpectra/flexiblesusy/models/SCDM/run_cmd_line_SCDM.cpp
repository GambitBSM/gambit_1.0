...
#include "SCDM_spectrum_generator.hpp"
...
{
   std::cout <<
      "Usage: run_cmd_line_SCDM.x [options]\n"
      "Options:\n"
      "  --HiggsIN=<value>\n"
      "  --Lambda2Input=<value>\n"
      "  --Lambda3Input=<value>\n"
...
int main(int argc, char* argv[])
{
   ...
   SCDM_spectrum_generator<algorithm_type> spectrum_generator;
   ...
   const SCDM_slha<algorithm_type> model(spectrum_generator.get_model());
   ...
   // SLHA output
   SLHAea::Coll slhaea(SCDM_slha_io::fill_slhaea(model, oneset, scales));
