...
#ifndef SCDM_TWO_SCALE_susy_parameters_H
#define SCDM_TWO_SCALE_susy_parameters_H
...
class SCDM_susy_parameters : public Beta_function {
public:
   explicit SCDM_susy_parameters(const SCDM_input_parameters& input_ = SCDM_input_parameters());
   SCDM_susy_parameters(double scale_, double loops_, double thresholds_, const SCDM_input_parameters& input_, double g1_, double g2_, double g3_, double LamS_, double LamSH_, double
   Lambda1_, const Eigen::Matrix<double,3,3>& Yu_, const Eigen::Matrix<double,3
   ,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
);
   virtual ~SCDM_susy_parameters() {}
   virtual Eigen::ArrayXd beta() const;
   virtual Eigen::ArrayXd get() const;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&);
   const SCDM_input_parameters& get_input() const;
   SCDM_input_parameters& get_input();
   void set_input_parameters(const SCDM_input_parameters&);

   SCDM_susy_parameters calc_beta() const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const SCDM_susy_parameters&);
