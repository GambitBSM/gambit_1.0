...
SCDM_initial_guesser<Two_scale>::SCDM_initial_guesser(
   SCDM<Two_scale>* model_,
   const softsusy::QedQcd& oneset_,
   const SCDM_low_scale_constraint<Two_scale>& low_constraint_,
   const SCDM_susy_scale_constraint<Two_scale>& susy_constraint_,
   const SCDM_high_scale_constraint<Two_scale>& high_constraint_
)
...
{
   assert(model && "SCDM_initial_guesser: Error: pointer to model"
          " SCDM<Two_scale> must not be zero");
}
 ...
 */
void SCDM_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void SCDM_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void SCDM_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void SCDM_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void SCDM_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void SCDM_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void SCDM_initial_guesser<Two_scale>::guess_soft_parameters()
{
