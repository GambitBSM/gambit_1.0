...
char const * const SCDM_slha_io::drbar_blocks[NUMBER_OF_DRBAR_BLOCKS] =
   { "gauge", "Yu", "Yd", "Ye", "HMIX", "SM", "MSOFT", "HDM" }
;

SCDM_slha_io::SCDM_slha_io()
   : slha_io()
{
}

void SCDM_slha_io::clear()
{
   slha_io.clear();
}
 ...
 */
void SCDM_slha_io::set_extpar(const SCDM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void SCDM_slha_io::set_minpar(const SCDM_input_parameters& input)
{
 ...
 */
void SCDM_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void SCDM_slha_io::set_spinfo(const Problems<SCDM_info::NUMBER_OF_PARTICLES>& problems)
{
   ...
   spinfo << FORMAT_SPINFO(5, SCDM_info::model_name)
 ...
 */
void SCDM_slha_io::set_mass(const SCDM_physical& physical,
 ...
 */
void SCDM_slha_io::set_mixing_matrices(const SCDM_physical& physical,
 ...
 */
void SCDM_slha_io::write_to_file(const std::string& file_name)
{
 ...
 */
double SCDM_slha_io::get_parameter_output_scale() const
{
 ...
 * @param file_name file name
 */
void SCDM_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void SCDM_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void SCDM_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void SCDM_slha_io::fill(SCDM_input_parameters& input) const
{
   SLHA_io::Tuple_processor minpar_processor
      = boost::bind(&SCDM_slha_io::fill_minpar_tuple, boost::ref(input), _1, _2);
   SLHA_io::Tuple_processor extpar_processor
      = boost::bind(&SCDM_slha_io::fill_extpar_tuple, boost::ref(input), _1, _2);
 ...
 */
void SCDM_slha_io::fill_drbar_parameters(SCDM_mass_eigenstates& model) const
{
 ...
 */
void SCDM_slha_io::fill(SCDM_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   SCDM_physical physical_hk;
 ...
 */
void SCDM_slha_io::fill(Spectrum_generator_settings& settings) const
{
   slha_io.fill(settings);
}

void SCDM_slha_io::fill_minpar_tuple(SCDM_input_parameters& input,
...
void SCDM_slha_io::fill_extpar_tuple(SCDM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void SCDM_slha_io::fill_physical(SCDM_physical& physical) const
{
   {
 ...
 */
double SCDM_slha_io::read_scale() const
{
   double scale = 0.;
