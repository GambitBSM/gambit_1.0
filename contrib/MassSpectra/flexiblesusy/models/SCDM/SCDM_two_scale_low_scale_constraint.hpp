...
#ifndef SCDM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define SCDM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "SCDM_low_scale_constraint.hpp"
...
template<>
class SCDM_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   SCDM_low_scale_constraint();
   SCDM_low_scale_constraint(SCDM<Two_scale>*, const softsusy::QedQcd&);
   virtual ~SCDM_low_scale_constraint();
   virtual void apply();
