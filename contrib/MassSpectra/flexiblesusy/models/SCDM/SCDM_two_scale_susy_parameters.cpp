...
// File generated at Tue 29 Dec 2015 16:23:38

#include "SCDM_two_scale_susy_parameters.hpp"
...
#define CLASSNAME SCDM_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces

SCDM_susy_parameters::SCDM_susy_parameters(const SCDM_input_parameters& input_)
   : Beta_function()
...
SCDM_susy_parameters::SCDM_susy_parameters(
   double scale_, double loops_, double thresholds_,
   const SCDM_input_parameters& input_
...
Eigen::ArrayXd SCDM_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

SCDM_susy_parameters SCDM_susy_parameters::calc_beta() const
{
   ...
   return SCDM_susy_parameters(get_scale(), get_loops(), get_thresholds(), input,
                    beta_g1, beta_g2, beta_g3, beta_LamS, beta_LamSH, beta_Lambda1, beta_Yu, beta_Yd, beta_Ye);
}

void SCDM_susy_parameters::clear()
{
   reset();
   g1 = 0.;
   g2 = 0.;
...
Eigen::ArrayXd SCDM_susy_parameters::get() const
{
...
void SCDM_susy_parameters::print(std::ostream& ostr) const
{
...
void SCDM_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   g1 = pars(0);
   g2 = pars(1);
   g3 = pars(2);
...
const SCDM_input_parameters& SCDM_susy_parameters::get_input() const
{
   return input;
}

SCDM_input_parameters& SCDM_susy_parameters::get_input()
{
   return input;
}

void SCDM_susy_parameters::set_input_parameters(const SCDM_input_parameters& input_)
{
   input = input_;
}

void SCDM_susy_parameters::calc_susy_traces(Susy_traces& susy_traces) const
{
...
std::ostream& operator<<(std::ostream& ostr, const SCDM_susy_parameters& susy_pars)
{
