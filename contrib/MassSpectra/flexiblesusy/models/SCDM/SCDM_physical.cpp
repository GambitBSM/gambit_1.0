 ...
 * to be complex.
 */
void SCDM_physical::convert_to_hk()
{
 ...
 * be negative.
 */
void SCDM_physical::convert_to_slha()
{

}

void SCDM_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const SCDM_physical& phys_pars)
{
