...
/**
 * @file SCDM_mass_eigenstates.cpp
...
#include "SCDM_mass_eigenstates.hpp"
...
#define CLASSNAME SCDM_mass_eigenstates
...
CLASSNAME::SCDM_mass_eigenstates(const SCDM_input_parameters& input_)
   : SCDM_soft_parameters(input_)
   ...
   , physical()
   , problems(SCDM_info::particle_names)
...
CLASSNAME::~SCDM_mass_eigenstates()
{
}
...
const SCDM_physical& CLASSNAME::get_physical() const
{
   return physical;
}

SCDM_physical& CLASSNAME::get_physical()
{
   return physical;
}

void CLASSNAME::set_physical(const SCDM_physical& physical_)
{
   physical = physical_;
}

const Problems<SCDM_info::NUMBER_OF_PARTICLES>& CLASSNAME::get_problems() const
{
   return problems;
}

Problems<SCDM_info::NUMBER_OF_PARTICLES>& CLASSNAME::get_problems()
{
   return problems;
}
...
int CLASSNAME::tadpole_equations(const gsl_vector* x, void* params, gsl_vector* f)
{
   ...
   SCDM_mass_eigenstates* model = ewsb_args->model;
...
void CLASSNAME::print(std::ostream& ostr) const
{
   ostr << "========================================\n"
           "SCDM\n"
           "========================================\n";
   SCDM_soft_parameters::print(ostr);
   ostr << "----------------------------------------\n"
...
{
   if (PHYSICAL(Mss) < 0.) problems.flag_tachyon(ss);
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   SCDM_soft_parameters::run_to(scale, eps);
}
...
void CLASSNAME::calculate_MHp()
{
   ...
   if (MHp < 0.)
      problems.flag_tachyon(SCDM_info::Hp);
...
void CLASSNAME::calculate_Mss()
{
   ...
   if (Mss < 0.)
      problems.flag_tachyon(SCDM_info::ss);
...
void CLASSNAME::calculate_MAh()
{
   ...
   if (MAh < 0.)
      problems.flag_tachyon(SCDM_info::Ah);
...
void CLASSNAME::calculate_Mhh()
{
   ...
   if (Mhh < 0.)
      problems.flag_tachyon(SCDM_info::hh);
...
void CLASSNAME::calculate_MVZ()
{
   ...
   if (MVZ < 0.)
      problems.flag_tachyon(SCDM_info::VZ);
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(SCDM_info::Fd, eigenvalue_error > precision *
      Abs(MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(SCDM_info::Fu, eigenvalue_error > precision *
      Abs(MFu(0)));
#else
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(SCDM_info::Fe, eigenvalue_error > precision *
      Abs(MFe(0)));
#else
...
void CLASSNAME::calculate_MVWp()
{
   ...
   if (MVWp < 0.)
      problems.flag_tachyon(SCDM_info::VWp);
...
double CLASSNAME::CpHpconjHpconjssss() const
{
   double result = 0.0;
...
double CLASSNAME::Cpconjsssshh() const
{
   double result = 0.0;
...
double CLASSNAME::CpssconjssAhAh() const
{
   double result = 0.0;
...
double CLASSNAME::Cpssconjsshhhh() const
{
   double result = 0.0;
...
double CLASSNAME::CpssconjssconjHpHp() const
{
   double result = 0.0;
...
double CLASSNAME::Cpssconjssconjssss() const
{
   double result = 0.0;
...
double CLASSNAME::CpAhAhconjssss() const
{
   double result = 0.0;
...
double CLASSNAME::Cphhconjssss() const
{
   double result = 0.0;
...
double CLASSNAME::Cphhhhconjssss() const
{
   double result = 0.0;
...
std::complex<double> CLASSNAME::self_energy_Hp(double p ) const
{
   ...
   result += -(A0(Mss)*CpHpconjHpconjssss());
...
std::complex<double> CLASSNAME::self_energy_ss(double p ) const
{
   ...
   result += 0.5*AbsSqr(Cpconjssconjssconjss())*B0(p,Mss,Mss);
   result += AbsSqr(Cpconjsssshh())*B0(p,Mss,Mhh);
   result += -0.5*A0(MAh)*CpssconjssAhAh();
   result += -(A0(MHp)*CpssconjssconjHpHp());
   result += -(A0(Mss)*Cpssconjssconjssss());
   result += -0.5*A0(Mhh)*Cpssconjsshhhh();
...
void CLASSNAME::calculate_Mss_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SCDM_info::ss);
   else
      problems.unflag_no_pole_mass_convergence(SCDM_info::ss);
}
...
void CLASSNAME::calculate_MFv_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SCDM_info::Fv);
   else
      problems.unflag_no_pole_mass_convergence(SCDM_info::Fv);
}
...
void CLASSNAME::calculate_Mhh_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SCDM_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(SCDM_info::hh);
}
...
void CLASSNAME::calculate_MVZ_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SCDM_info::VZ);
   else
      problems.unflag_no_pole_mass_convergence(SCDM_info::VZ);
}
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   do {
      ...
      for (unsigned es = 0; es < 3; ++es) {
         ...
         fs_svd(M_1loop, eigen_values, mix_Vd, mix_Ud,
            eigenvalue_error);
         problems.flag_bad_mass(SCDM_info::Fd, eigenvalue_error >
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SCDM_info::Fd);
   else
      problems.unflag_no_pole_mass_convergence(SCDM_info::Fd);
}
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   do {
      ...
      for (unsigned es = 0; es < 3; ++es) {
         ...
         fs_svd(M_1loop, eigen_values, mix_Vu, mix_Uu,
            eigenvalue_error);
         problems.flag_bad_mass(SCDM_info::Fu, eigenvalue_error >
            precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_1loop, eigen_values, mix_Vu, mix_Uu);
      #endif
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SCDM_info::Fu);
   else
      problems.unflag_no_pole_mass_convergence(SCDM_info::Fu);
}
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   do {
      ...
      for (unsigned es = 0; es < 3; ++es) {
         ...
         fs_svd(M_1loop, eigen_values, mix_Ve, mix_Ue,
            eigenvalue_error);
         problems.flag_bad_mass(SCDM_info::Fe, eigenvalue_error >
            precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_1loop, eigen_values, mix_Ve, mix_Ue);
      #endif
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SCDM_info::Fe);
   else
      problems.unflag_no_pole_mass_convergence(SCDM_info::Fe);
}
...
void CLASSNAME::calculate_MVG_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SCDM_info::VG);
   else
      problems.unflag_no_pole_mass_convergence(SCDM_info::VG);
}
...
void CLASSNAME::calculate_MVP_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SCDM_info::VP);
   else
      problems.unflag_no_pole_mass_convergence(SCDM_info::VP);
}
...
void CLASSNAME::calculate_MVWp_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SCDM_info::VWp);
   else
      problems.unflag_no_pole_mass_convergence(SCDM_info::VWp);
}
...
std::ostream& operator<<(std::ostream& ostr, const SCDM_mass_eigenstates& model)
{
   model.print(ostr);
   return ostr;
}
