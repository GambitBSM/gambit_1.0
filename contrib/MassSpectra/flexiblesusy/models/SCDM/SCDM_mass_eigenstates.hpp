...
/**
 * @file SCDM_mass_eigenstates.hpp
 *
...
#ifndef SCDM_MASS_EIGENSTATES_H
#define SCDM_MASS_EIGENSTATES_H
...
class EWSB_solver;
/**
 * @class SCDM_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class SCDM_mass_eigenstates : public SCDM_soft_parameters {
public:
   explicit SCDM_mass_eigenstates(const SCDM_input_parameters& input_ = SCDM_input_parameters());
   virtual ~SCDM_mass_eigenstates();
   ...
   void set_physical(const SCDM_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const SCDM_physical& get_physical() const;
   SCDM_physical& get_physical();
   const Problems<SCDM_info::NUMBER_OF_PARTICLES>& get_problems() const;
   Problems<SCDM_info::NUMBER_OF_PARTICLES>& get_problems();
   ...
   double CpHpconjHpconjssss() const;
   ...
   double Cpconjsssshh() const;
   double Cpconjssconjssconjss() const;
   double CpssconjssAhAh() const;
   double Cpssconjsshhhh() const;
   double CpssconjssconjHpHp() const;
   double Cpssconjssconjssss() const;
   ...
   std::complex<double> self_energy_ss(double p ) const;
...
private:
   struct EWSB_args {
      SCDM_mass_eigenstates* model;
      unsigned ewsb_loop_order;
   };

#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(SCDM_mass_eigenstates::*Memfun_t)();
      SCDM_mass_eigenstates* model;
      Memfun_t fun;

      Thread(SCDM_mass_eigenstates* model_, Memfun_t fun_)
   ...
   SCDM_physical physical; ///< contains the pole masses and mixings
   Problems<SCDM_info::NUMBER_OF_PARTICLES> problems;
...
std::ostream& operator<<(std::ostream&, const SCDM_mass_eigenstates&);
