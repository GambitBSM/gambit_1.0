 ...
 */
double SCDM_soft_parameters::calc_beta_muH_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double SCDM_soft_parameters::calc_beta_muH_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_muH = Re(twoLoop*(4.1775*Power(g1,4)*muH - 9.0625*Power(g2,4)*muH
      ...
      traceYeAdjYeYeAdjYe - 36*Lambda1*muH*traceYuAdjYu - 13.5*muH*
      traceYuAdjYuYuAdjYu + 7.2*Lambda1*muH*Sqr(g1) + 4.25*muH*traceYuAdjYu*Sqr
 ...
 */
double SCDM_soft_parameters::calc_beta_muH_three_loop(const Soft_traces& soft_traces) const
{
