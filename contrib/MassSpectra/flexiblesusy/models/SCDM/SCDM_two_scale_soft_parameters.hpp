...
#ifndef SCDM_TWO_SCALE_soft_parameters_H
#define SCDM_TWO_SCALE_soft_parameters_H
...
class SCDM_soft_parameters : public SCDM_susy_parameters {
public:
   explicit SCDM_soft_parameters(const SCDM_input_parameters& input_ = SCDM_input_parameters());
   SCDM_soft_parameters(const SCDM_susy_parameters& , double mu3_, double muS_, double muH_, double v_
);
   virtual ~SCDM_soft_parameters() {}
   virtual Eigen::ArrayXd beta() const;
   virtual Eigen::ArrayXd get() const;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&);

   SCDM_soft_parameters calc_beta() const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const SCDM_soft_parameters&);
