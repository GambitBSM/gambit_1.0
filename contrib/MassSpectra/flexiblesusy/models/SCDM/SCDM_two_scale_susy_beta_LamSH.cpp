 ...
 */
double SCDM_susy_parameters::calc_beta_LamSH_one_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_LamSH = Re(0.1*LamSH*oneOver16PiSqr*(60*Lambda1 + 80*LamS + 40*
 ...
 */
double SCDM_susy_parameters::calc_beta_LamSH_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_LamSH = Re(twoLoop*(4.1775*Power(g1,4)*LamSH - 9.0625*Power(g2,4)
      *LamSH - 11*Power(LamSH,3) - 13.5*LamSH*traceYdAdjYdYdAdjYd - 21*LamSH*
      ...
      40*LamSH*Sqr(LamS) - 36*Lambda1*Sqr(LamSH) - 48*LamS*Sqr(LamSH) - 12*
 ...
 */
double SCDM_susy_parameters::calc_beta_LamSH_three_loop(const Susy_traces& susy_traces) const
{
