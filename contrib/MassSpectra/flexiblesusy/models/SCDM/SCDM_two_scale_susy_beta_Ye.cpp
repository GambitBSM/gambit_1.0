 ...
 */
Eigen::Matrix<double,3,3> SCDM_susy_parameters::calc_beta_Ye_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> SCDM_susy_parameters::calc_beta_Ye_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Ye = (0.0025*twoLoop*(Ye*(2742*Power(g1,4) - 2300*Power(g2,4) -
      ...
      ) + 9*Sqr(g2) + 32*Sqr(g3)) + 600*Sqr(Lambda1) + 200*Sqr(LamSH)) + 15*((
 ...
 */
Eigen::Matrix<double,3,3> SCDM_susy_parameters::calc_beta_Ye_three_loop(const Susy_traces& susy_traces) const
{
