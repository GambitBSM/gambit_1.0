 ...
 */
double SCDM_susy_parameters::calc_beta_Lambda1_one_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Lambda1 = Re(oneOver16PiSqr*(0.27*Power(g1,4) + 2.25*Power(g2,4)
      ...
      g1)*Sqr(g2) + 12*Sqr(Lambda1) + 2*Sqr(LamSH)));
 ...
 */
double SCDM_susy_parameters::calc_beta_Lambda1_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Lambda1 = Re(twoLoop*(-3.411*Power(g1,6) + 38.125*Power(g2,6) +
      ...
      3) - 8*Power(LamSH,3) - 3*Lambda1*traceYdAdjYdYdAdjYd + 60*
      ...
      Lambda1*Sqr(g2) + 16*Sqr(Lambda1))) - 10*Lambda1*Sqr(LamSH)));
 ...
 */
double SCDM_susy_parameters::calc_beta_Lambda1_three_loop(const Susy_traces& susy_traces) const
{
