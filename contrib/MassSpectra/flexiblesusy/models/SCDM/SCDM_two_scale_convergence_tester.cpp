...
SCDM_convergence_tester<Two_scale>::SCDM_convergence_tester(SCDM<Two_scale>* model, double accuracy_goal)
   : Convergence_tester_DRbar<SCDM<Two_scale> >(model, accuracy_goal)
{
}

SCDM_convergence_tester<Two_scale>::~SCDM_convergence_tester()
{
}

double SCDM_convergence_tester<Two_scale>::max_rel_diff() const
{
   const SCDM<Two_scale>& ol = get_last_iteration_model();
   const SCDM<Two_scale>& ne = get_model();
