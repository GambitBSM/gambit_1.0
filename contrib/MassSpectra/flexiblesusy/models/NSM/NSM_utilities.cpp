   ...
   const NSM_observables* observables)
{
   ...
   append(names, NSM_parameter_getter().get_mass_names());
   append(names, NSM_parameter_getter().get_mixing_names());
   ...
   Physical_input* physical_input, NSM_observables* observables)
{
   ...
   const std::size_t number_of_masses = NSM_parameter_getter().get_number_of_masses();
   const std::size_t number_of_mixings = NSM_info::NUMBER_OF_MIXINGS;
   const std::size_t number_of_input_parameters = NSM_info::NUMBER_OF_INPUT_PARAMETERS;
   ...
   const std::size_t number_of_observables =
      (observables ? NSM_observables::NUMBER_OF_OBSERVABLES : 0u);
