 ...
 */
double SingletDM_susy_parameters::calc_beta_Lambda2_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double SingletDM_susy_parameters::calc_beta_Lambda2_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Lambda2 = Re(twoLoop*(4.1775*Power(g1,4)*Lambda2 - 9.0625*Power(
      ...
      Sqr(g3)) - 15*Lambda2*Sqr(Lambda1) - 72*Lambda1*Sqr(Lambda2) - 24*
      traceYuAdjYu*Sqr(Lambda2) + 1.2*Sqr(g1)*Sqr(Lambda2) + 6*Sqr(g2)*Sqr(
      Lambda2)));
 ...
 */
double SingletDM_susy_parameters::calc_beta_Lambda2_three_loop(const Susy_traces& susy_traces) const
{
