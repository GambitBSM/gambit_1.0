...
{
   assert(model && "Error: SingletDM_susy_scale_constraint::apply():"
...
{
   assert(model && "Error: SingletDM_susy_scale_constraint::"
...
void SingletDM_susy_scale_constraint<Two_scale>::set_model(Two_scale_model* model_)
{
...
{
   assert(model && "SingletDM_susy_scale_constraint<Two_scale>::"
