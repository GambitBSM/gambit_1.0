   ...
   const SingletDM_observables* observables)
{
   ...
   append(names, SingletDM_parameter_getter().get_mass_names());
   append(names, SingletDM_parameter_getter().get_mixing_names());
   ...
   Physical_input* physical_input, SingletDM_observables* observables)
{
   ...
   const std::size_t number_of_masses = SingletDM_parameter_getter().get_number_of_masses();
   const std::size_t number_of_mixings = SingletDM_info::NUMBER_OF_MIXINGS;
   const std::size_t number_of_input_parameters = SingletDM_info::NUMBER_OF_INPUT_PARAMETERS;
   ...
   const std::size_t number_of_observables =
      (observables ? SingletDM_observables::NUMBER_OF_OBSERVABLES : 0u);
