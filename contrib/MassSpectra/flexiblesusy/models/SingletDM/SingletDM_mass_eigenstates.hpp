...
public:
   ...
   virtual ~SingletDM_mass_eigenstates();
   ...
   Problems<SingletDM_info::NUMBER_OF_PARTICLES>& get_problems();
...
private:
...
#ifdef ENABLE_THREADS
   struct Thread {
      typedef void(SingletDM_mass_eigenstates::*Memfun_t)();
      SingletDM_mass_eigenstates* model;
      Memfun_t fun;

      Thread(SingletDM_mass_eigenstates* model_, Memfun_t fun_)
   ...
   Problems<SingletDM_info::NUMBER_OF_PARTICLES> problems;
