...
// File generated at Sat 27 Aug 2016 12:42:56
...
Eigen::Matrix<double,3,3> SingletDM_susy_parameters::calc_beta_Yd_two_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_Yd = (twoLoop*(Yd*(-0.21166666666666667*Power(g1,4) - 5.75*Power(
      ...
      *Sqr(g2) + 1.875*traceYeAdjYe*(Sqr(g1) + Sqr(g2)) + 20*traceYuAdjYu*Sqr(
      ...
      traceYdAdjYd*(Sqr(g1) + 9*Sqr(g2) + 32*Sqr(g3)) + 1.5*Sqr(LamH) + 0.25*
      Sqr(LamSH)) + 0.0125*((-480*LamH - 540*traceYdAdjYd - 180*traceYeAdjYe -
