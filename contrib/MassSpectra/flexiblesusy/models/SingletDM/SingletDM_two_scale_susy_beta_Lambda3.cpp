 ...
 */
double SingletDM_susy_parameters::calc_beta_Lambda3_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double SingletDM_susy_parameters::calc_beta_Lambda3_two_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double SingletDM_susy_parameters::calc_beta_Lambda3_three_loop(const Susy_traces& susy_traces) const
{
