...
// File generated at Tue 29 Dec 2015 17:22:21

/**
 * @file SingletDM_two_scale_model_slha.cpp
 * @brief SingletDM model class wrapper for SLHA conversion
 */
...
#define CLASSNAME SingletDM_slha<Two_scale>
#define LOCALPHYSICAL(p) physical.p

CLASSNAME::SingletDM_slha(const SingletDM_input_parameters& input_)
   : SingletDM<Two_scale>(input_)
   , physical_slha()
 ...
 */
CLASSNAME::SingletDM_slha(const SingletDM<Two_scale>& model_)
   : SingletDM<Two_scale>(model_)
{
   convert_to_slha();
}

CLASSNAME::~SingletDM_slha()
{
}

void CLASSNAME::clear()
{
   SingletDM<Two_scale>::clear();
   physical_slha.clear();
}

void CLASSNAME::calculate_spectrum()
{
   SingletDM<Two_scale>::calculate_spectrum();
   convert_to_slha();
}
...
const SingletDM_physical& CLASSNAME::get_physical_slha() const
{
   return physical_slha;
}

SingletDM_physical& CLASSNAME::get_physical_slha()
{
   return physical_slha;
}
...
{
   SingletDM<Two_scale>::print(ostr);
