...
CLASSNAME::SingletDM_mass_eigenstates(const SingletDM_input_parameters& input_)
   ...
   , physical()
   , problems(SingletDM_info::particle_names)
...
CLASSNAME::~SingletDM_mass_eigenstates()
{
}
...
const Problems<SingletDM_info::NUMBER_OF_PARTICLES>& CLASSNAME::get_problems() const
{
   return problems;
}

Problems<SingletDM_info::NUMBER_OF_PARTICLES>& CLASSNAME::get_problems()
{
   return problems;
}
...
int CLASSNAME::ewsb_step(double ewsb_parameters[number_of_ewsb_equations]) const
{
   ...
   Lambda1 = Re((-2*(mu2*v - tadpole[0]))/Power(v,3));
...
{
   const double mass_matrix_Hp = Re(0.25*(4*mu2 + 2*Lambda1*Sqr(v) + Sqr(
      g2)*Sqr(v)));
...
void CLASSNAME::calculate_MHp()
{
   ...
   if (MHp < 0.)
      problems.flag_tachyon(SingletDM_info::Hp);
...
void CLASSNAME::calculate_Mss()
{
   ...
   if (Mss < 0.)
      problems.flag_tachyon(SingletDM_info::ss);
...
{
   const double mass_matrix_Ah = Re(0.25*(2*(2*mu2 + Lambda1*Sqr(v)) +
...
void CLASSNAME::calculate_MAh()
{
   ...
   if (MAh < 0.)
      problems.flag_tachyon(SingletDM_info::Ah);
...
{
   const double mass_matrix_hh = Re(mu2 + 1.5*Lambda1*Sqr(v));
...
void CLASSNAME::calculate_Mhh()
{
   ...
   if (Mhh < 0.)
      problems.flag_tachyon(SingletDM_info::hh);
...
void CLASSNAME::calculate_MVZ()
{
   ...
   if (MVZ < 0.)
      problems.flag_tachyon(SingletDM_info::VZ);
...
void CLASSNAME::calculate_MVWp()
{
   ...
   if (MVWp < 0.)
      problems.flag_tachyon(SingletDM_info::VWp);
...
{
   double result = Re(mu2*v + 0.5*Lambda1*Power(v,3));
