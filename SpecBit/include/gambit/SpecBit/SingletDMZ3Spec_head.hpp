...
namespace Gambit {
   namespace SpecBit {
      ...
      template <class MI>
      class SingletDMZ3Spec : public Spec<SingletDMZ3Spec<MI>,SingletDMZ3SpecTraits<MI>>
      {
         friend class RunparDer<SingletDMZ3Spec<MI>,SingletDMZ3SpecTraits<MI>>;
         friend class PhysDer  <SingletDMZ3Spec<MI>,SingletDMZ3SpecTraits<MI>>;
        
         public:
            typedef MapTypes<SingletDMZ3SpecTraits<MI>,MapTag::Get> MTget;
            typedef MapTypes<SingletDMZ3SpecTraits<MI>,MapTag::Set> MTset;
         ...
         public:
            ...
            //constructors
            SingletDMZ3Spec(bool switch_index_convention=false);
            SingletDMZ3Spec(MI, str backend_name, str backend_version, bool switch_index_convention=false);
            ...
            typename SingletDMZ3SpecTraits<MI>::Model& get_Model() { return model_interface.model; }
            typename SingletDMZ3SpecTraits<MI>::Input& get_Input() { return dummyinput; /*unused here, but needs to be defined for the interface*/ }
            ...
            // Should work from any flexiblesusy model object with the same particle content as the SingletDMZ3
