...
namespace Gambit {
   namespace SpecBit {
      ...
      template <class MI>
      class SingletDMSpec : public Spec<SingletDMSpec<MI>,SingletDMSpecTraits<MI>>
      {
         friend class RunparDer<SingletDMSpec<MI>,SingletDMSpecTraits<MI>>;
         friend class PhysDer  <SingletDMSpec<MI>,SingletDMSpecTraits<MI>>;
        
         public:
            typedef MapTypes<SingletDMSpecTraits<MI>,MapTag::Get> MTget;
            typedef MapTypes<SingletDMSpecTraits<MI>,MapTag::Set> MTset;
         ...
         public:
            ...
            //constructors
            SingletDMSpec(bool switch_index_convention=false);
            SingletDMSpec(MI, str backend_name, str backend_version, bool switch_index_convention=false);
            ...
            typename SingletDMSpecTraits<MI>::Model& get_Model() { return model_interface.model; }
            typename SingletDMSpecTraits<MI>::Input& get_Input() { return dummyinput; /*unused here, but needs to be defined for the interface*/ }
            ...
            // Should work from any flexiblesusy model object with the same particle content as the SingletDM
