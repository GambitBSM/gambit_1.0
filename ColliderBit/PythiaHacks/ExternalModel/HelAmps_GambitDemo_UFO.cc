    ...
    double M1, double W1, complex<double> F1[])
{
  ...
  F1[3] = denom * - cI * (F2[2] * (P1[0] * (+cI * (V3[4]) - V3[3]) + (P1[1] *
      ...
      (V3[2] + V3[5])))));
  F1[4] = denom * - cI * M1 * (F2[2] * (V3[5] - V3[2]) + F2[3] * (V3[3] + cI *
      (V3[4])));
  F1[5] = denom * cI * M1 * (F2[2] * (+cI * (V3[4]) - V3[3]) + F2[3] * (V3[2] +
      V3[5]));
}
    ...
    complex<double> COUP, double M3, double W3, complex<double> V3[])
{
  ...
  V3[2] = denom * (OM3 * P3[0] * (-2. * cI * (TMP12 * TMP27) + cI * (TMP17 *
      TMP20 + TMP10 * TMP21)) + (-cI * (V2[2] * TMP20 + V1[2] * TMP21) + 2. *
      cI * (TMP12 * V4[2])));
  V3[3] = denom * (OM3 * P3[1] * (-2. * cI * (TMP12 * TMP27) + cI * (TMP17 *
      TMP20 + TMP10 * TMP21)) + (-cI * (V2[3] * TMP20 + V1[3] * TMP21) + 2. *
      cI * (TMP12 * V4[3])));
  V3[4] = denom * (OM3 * P3[2] * (-2. * cI * (TMP12 * TMP27) + cI * (TMP17 *
      TMP20 + TMP10 * TMP21)) + (-cI * (V2[4] * TMP20 + V1[4] * TMP21) + 2. *
      cI * (TMP12 * V4[4])));
  V3[5] = denom * (OM3 * P3[3] * (-2. * cI * (TMP12 * TMP27) + cI * (TMP17 *
      TMP20 + TMP10 * TMP21)) + (-cI * (V2[5] * TMP20 + V1[5] * TMP21) + 2. *
      cI * (TMP12 * V4[5])));
}
    ...
    complex<double> COUP, double M3, double W3, complex<double> V3[])
{
  ...
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  V3[2] = denom * (OM3 * P3[0] * (-cI * (TMP12 * TMP27) + cI * (TMP10 * TMP21))
      + (-cI * (V1[2] * TMP21) + cI * (TMP12 * V4[2])));
  V3[3] = denom * (OM3 * P3[1] * (-cI * (TMP12 * TMP27) + cI * (TMP10 * TMP21))
      + (-cI * (V1[3] * TMP21) + cI * (TMP12 * V4[3])));
  V3[4] = denom * (OM3 * P3[2] * (-cI * (TMP12 * TMP27) + cI * (TMP10 * TMP21))
      + (-cI * (V1[4] * TMP21) + cI * (TMP12 * V4[4])));
  V3[5] = denom * (OM3 * P3[3] * (-cI * (TMP12 * TMP27) + cI * (TMP10 * TMP21))
    ...
    double M2, double W2, complex<double> S2[])
{
  ...
  denom = COUP/(pow(P2[0], 2) - pow(P2[1], 2) - pow(P2[2], 2) - pow(P2[3], 2) -
      M2 * (M2 - cI * W2));
  S2[2] = denom * cI * TMP8 * S3[2]; 
}

void VSS1_3_2(complex<double> V1[], complex<double> S3[], complex<double>
    COUP1, complex<double> COUP2, double M2, double W2, complex<double> S2[])
{
  complex<double> cI = complex<double> (0., 1.); 
  double P2[4]; 
  complex<double> denom; 
  ...
  int i; 
  VSS1_2(V1, S3, COUP1, M2, W2, S2); 
  VSS3_2(V1, S3, COUP2, M2, W2, Stmp); 
  i = 2; 
  while (i < 3)
  {
    S2[i] = S2[i] + Stmp[i]; 
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  vertex = COUP * (TMP12 * (-cI * (TMP14) + cI * (TMP15)) + (TMP16 * (-cI *
      (TMP17) + cI * (TMP13)) + TMP18 * (-cI * (TMP8) + cI * (TMP10))));
}


void VSS3_3(complex<double> V1[], complex<double> S2[], complex<double> COUP,
    double M3, double W3, complex<double> S3[])
{
  complex<double> cI = complex<double> (0., 1.); 
  complex<double> TMP10; 
    ...
    double M2, double W2, complex<double> V2[])
{
  ...
  V2[2] = denom * (TMP16 * (-cI * (P3[0]) + cI * (P1[0])) + (V1[2] * (-cI *
      (TMP14) + cI * (TMP15)) + V3[2] * (-cI * (TMP8) + cI * (TMP10))));
  V2[3] = denom * (TMP16 * (-cI * (P3[1]) + cI * (P1[1])) + (V1[3] * (-cI *
      (TMP14) + cI * (TMP15)) + V3[3] * (-cI * (TMP8) + cI * (TMP10))));
  V2[4] = denom * (TMP16 * (-cI * (P3[2]) + cI * (P1[2])) + (V1[4] * (-cI *
      (TMP14) + cI * (TMP15)) + V3[4] * (-cI * (TMP8) + cI * (TMP10))));
  V2[5] = denom * (TMP16 * (-cI * (P3[3]) + cI * (P1[3])) + (V1[5] * (-cI *
      (TMP14) + cI * (TMP15)) + V3[5] * (-cI * (TMP8) + cI * (TMP10))));
}


void VSS2_2(complex<double> V1[], complex<double> S3[], complex<double> COUP,
    double M2, double W2, complex<double> S2[])
{
  complex<double> cI = complex<double> (0., 1.); 
  complex<double> TMP10; 
  ...
  denom = COUP/(pow(P2[0], 2) - pow(P2[1], 2) - pow(P2[2], 2) - pow(P2[3], 2) -
      M2 * (M2 - cI * W2));
  S2[2] = denom * S3[2] * (-cI * (TMP10) + cI * (TMP8)); 
}
    ...
    double M2, double W2, complex<double> F2[])
{
  ...
  denom = COUP/(pow(P2[0], 2) - pow(P2[1], 2) - pow(P2[2], 2) - pow(P2[3], 2) -
      M2 * (M2 - cI * W2));
  F2[2] = denom * cI * M2 * (F1[4] * (V3[2] - V3[5]) + F1[5] * (+cI * (V3[4]) -
      V3[3]));
  F2[3] = denom * - cI * M2 * (F1[4] * (V3[3] + cI * (V3[4])) - F1[5] * (V3[2]
      + V3[5]));
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  P2[3] = S2[0].imag(); 
  TMP8 = (P2[0] * V1[2] - P2[1] * V1[3] - P2[2] * V1[4] - P2[3] * V1[5]); 
  vertex = COUP * - cI * TMP8 * S3[2] * S2[2]; 
}

void VSS1_3_0(complex<double> V1[], complex<double> S2[], complex<double> S3[],
    complex<double> COUP1, complex<double> COUP2, complex<double> & vertex)
{
  complex<double> cI = complex<double> (0., 1.); 
  double P2[4]; 
  complex<double> tmp; 
  VSS1_0(V1, S2, S3, COUP1, vertex); 
  VSS3_0(V1, S2, S3, COUP2, tmp); 
  vertex = vertex + tmp; 
}
    ...
    double M2, double W2, complex<double> V2[])
{
  ...
  denom = COUP/(pow(P2[0], 2) - pow(P2[1], 2) - pow(P2[2], 2) - pow(P2[3], 2) -
      M2 * (M2 - cI * W2));
  V2[2] = denom * (OM2 * P2[0] * (TMP16 * (-cI * (TMP9) + cI * (TMP19)) + (-cI
      * (TMP10 * TMP15) + cI * (TMP8 * TMP14))) + (TMP16 * (-cI * (P3[0]) + cI
      * (P1[0])) + (V1[2] * (-cI * (TMP14) + cI * (TMP15)) + V3[2] * (-cI *
      (TMP8) + cI * (TMP10)))));
  V2[3] = denom * (OM2 * P2[1] * (TMP16 * (-cI * (TMP9) + cI * (TMP19)) + (-cI
      * (TMP10 * TMP15) + cI * (TMP8 * TMP14))) + (TMP16 * (-cI * (P3[1]) + cI
      * (P1[1])) + (V1[3] * (-cI * (TMP14) + cI * (TMP15)) + V3[3] * (-cI *
      (TMP8) + cI * (TMP10)))));
  V2[4] = denom * (OM2 * P2[2] * (TMP16 * (-cI * (TMP9) + cI * (TMP19)) + (-cI
      * (TMP10 * TMP15) + cI * (TMP8 * TMP14))) + (TMP16 * (-cI * (P3[2]) + cI
      * (P1[2])) + (V1[4] * (-cI * (TMP14) + cI * (TMP15)) + V3[4] * (-cI *
      (TMP8) + cI * (TMP10)))));
  V2[5] = denom * (OM2 * P2[3] * (TMP16 * (-cI * (TMP9) + cI * (TMP19)) + (-cI
      * (TMP10 * TMP15) + cI * (TMP8 * TMP14))) + (TMP16 * (-cI * (P3[3]) + cI
...
void VSS2_0(complex<double> V1[], complex<double> S2[], complex<double> S3[],
    complex<double> COUP, complex<double> & vertex)
{
  complex<double> cI = complex<double> (0., 1.); 
  complex<double> TMP10; 
  ...
  TMP8 = (P2[0] * V1[2] - P2[1] * V1[3] - P2[2] * V1[4] - P2[3] * V1[5]); 
  TMP10 = (P3[0] * V1[2] - P3[1] * V1[3] - P3[2] * V1[4] - P3[3] * V1[5]); 
  vertex = COUP * S2[2] * S3[2] * (-cI * (TMP8) + cI * (TMP10)); 
}


void FFS2P0_2(complex<double> F1[], complex<double> S3[], complex<double> COUP,
    double M2, double W2, complex<double> F2[])
{
  complex<double> cI = complex<double> (0., 1.); 
  double P2[4]; 
...
void VSS2P0_1(complex<double> S2[], complex<double> S3[], complex<double> COUP,
    ...
    double M3, double W3, complex<double> S3[])
{
  ...
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  S3[2] = denom * cI * TMP8 * S2[2]; 
}

void VSS1_3_3(complex<double> V1[], complex<double> S2[], complex<double>
    COUP1, complex<double> COUP2, double M3, double W3, complex<double> S3[])
{
  ...
  complex<double> Stmp[3]; 
  int i; 
  VSS1_3(V1, S2, COUP1, M3, W3, S3); 
  VSS3_3(V1, S2, COUP2, M3, W3, Stmp); 
  i = 2; 
  while (i < 3)
  {
    S3[i] = S3[i] + Stmp[i]; 
...
void VSS3_0(complex<double> V1[], complex<double> S2[], complex<double> S3[],
    complex<double> COUP, complex<double> & vertex)
{
  complex<double> cI = complex<double> (0., 1.); 
  complex<double> TMP10; 
  ...
  P3[3] = S3[0].imag(); 
  TMP10 = (P3[0] * V1[2] - P3[1] * V1[3] - P3[2] * V1[4] - P3[3] * V1[5]); 
  vertex = COUP * - cI * TMP10 * S3[2] * S2[2]; 
}
    ...
    double M3, double W3, complex<double> V3[])
{
  ...
  V3[2] = denom * (TMP12 * (-cI * (P1[0]) + cI * (P2[0])) + (V1[2] * (-cI *
      (TMP17) + cI * (TMP13)) + V2[2] * (-cI * (TMP8) + cI * (TMP10))));
  V3[3] = denom * (TMP12 * (-cI * (P1[1]) + cI * (P2[1])) + (V1[3] * (-cI *
      (TMP17) + cI * (TMP13)) + V2[3] * (-cI * (TMP8) + cI * (TMP10))));
  V3[4] = denom * (TMP12 * (-cI * (P1[2]) + cI * (P2[2])) + (V1[4] * (-cI *
      (TMP17) + cI * (TMP13)) + V2[4] * (-cI * (TMP8) + cI * (TMP10))));
  V3[5] = denom * (TMP12 * (-cI * (P1[3]) + cI * (P2[3])) + (V1[5] * (-cI *
      (TMP17) + cI * (TMP13)) + V2[5] * (-cI * (TMP8) + cI * (TMP10))));
}
    ...
    double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * S2[2] * S3[2] * (-cI * (P2[0]) + cI * (P1[0] * OM1 * TMP9)); 
  V1[3] = denom * S2[2] * S3[2] * (-cI * (P2[1]) + cI * (P1[1] * OM1 * TMP9)); 
  V1[4] = denom * S2[2] * S3[2] * (-cI * (P2[2]) + cI * (P1[2] * OM1 * TMP9)); 
  V1[5] = denom * S2[2] * S3[2] * (-cI * (P2[3]) + cI * (P1[3] * OM1 * TMP9)); 
}

void VSS1_3_1(complex<double> S2[], complex<double> S3[], complex<double>
    COUP1, complex<double> COUP2, double M1, double W1, complex<double> V1[])
{
  ...
  complex<double> Vtmp[6]; 
  double OM1; 
  VSS1_1(S2, S3, COUP1, M1, W1, V1); 
  VSS3_1(S2, S3, COUP2, M1, W1, Vtmp); 
  i = 2; 
  while (i < 6)
  {
    V1[i] = V1[i] + Vtmp[i]; 
...
void VSS2_3(complex<double> V1[], complex<double> S2[], complex<double> COUP,
    double M3, double W3, complex<double> S3[])
{
  complex<double> cI = complex<double> (0., 1.); 
  complex<double> TMP10; 
  ...
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  S3[2] = denom * S2[2] * (-cI * (TMP10) + cI * (TMP8)); 
}
    ...
    double M3, double W3, complex<double> V3[])
{
  ...
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  V3[2] = denom * - cI * (F2[2] * F1[4] + F2[3] * F1[5] - P3[0] * OM3 * TMP7); 
  V3[3] = denom * - cI * (F2[3] * F1[4] + F2[2] * F1[5] - P3[1] * OM3 * TMP7); 
  V3[4] = denom * - cI * (-cI * (F2[2] * F1[5]) + cI * (F2[3] * F1[4]) - P3[2]
      * OM3 * TMP7);
  V3[5] = denom * - cI * (F2[2] * F1[4] - F2[3] * F1[5] - P3[3] * OM3 * TMP7); 
}
...
void VSS3_1(complex<double> S2[], complex<double> S3[], complex<double> COUP,
    double M1, double W1, complex<double> V1[])
{
  complex<double> cI = complex<double> (0., 1.); 
  complex<double> TMP11; 
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * S2[2] * S3[2] * (-cI * (P3[0]) + cI * (P1[0] * OM1 * TMP11)); 
  V1[3] = denom * S2[2] * S3[2] * (-cI * (P3[1]) + cI * (P1[1] * OM1 * TMP11)); 
  V1[4] = denom * S2[2] * S3[2] * (-cI * (P3[2]) + cI * (P1[2] * OM1 * TMP11)); 
  V1[5] = denom * S2[2] * S3[2] * (-cI * (P3[3]) + cI * (P1[3] * OM1 * TMP11)); 
}
...
void VSS2_1(complex<double> S2[], complex<double> S3[], complex<double> COUP,
    double M1, double W1, complex<double> V1[])
{
  complex<double> cI = complex<double> (0., 1.); 
  complex<double> TMP11; 
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * S2[2] * S3[2] * (OM1 * P1[0] * (-cI * (TMP11) + cI * (TMP9))
      + (-cI * (P2[0]) + cI * (P3[0])));
  V1[3] = denom * S2[2] * S3[2] * (OM1 * P1[1] * (-cI * (TMP11) + cI * (TMP9))
      + (-cI * (P2[1]) + cI * (P3[1])));
  V1[4] = denom * S2[2] * S3[2] * (OM1 * P1[2] * (-cI * (TMP11) + cI * (TMP9))
      + (-cI * (P2[2]) + cI * (P3[2])));
  V1[5] = denom * S2[2] * S3[2] * (OM1 * P1[3] * (-cI * (TMP11) + cI * (TMP9))
      + (-cI * (P2[3]) + cI * (P3[3])));
}
    ...
    complex<double> COUP, double M3, double W3, complex<double> V3[])
{
  ...
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  V3[2] = denom * (OM3 * P3[0] * (-cI * (TMP10 * TMP21) + cI * (TMP17 * TMP20))
      + (-cI * (V2[2] * TMP20) + cI * (V1[2] * TMP21)));
  V3[3] = denom * (OM3 * P3[1] * (-cI * (TMP10 * TMP21) + cI * (TMP17 * TMP20))
      + (-cI * (V2[3] * TMP20) + cI * (V1[3] * TMP21)));
  V3[4] = denom * (OM3 * P3[2] * (-cI * (TMP10 * TMP21) + cI * (TMP17 * TMP20))
      + (-cI * (V2[4] * TMP20) + cI * (V1[4] * TMP21)));
  V3[5] = denom * (OM3 * P3[3] * (-cI * (TMP10 * TMP21) + cI * (TMP17 * TMP20))
