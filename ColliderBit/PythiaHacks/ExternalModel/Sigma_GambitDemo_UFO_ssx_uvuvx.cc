...
#include "Sigma_GambitDemo_UFO_ssx_uvuvx.h"
...
void Sigma_GambitDemo_UFO_ssx_uvuvx::initProc() 
{
...
void Sigma_GambitDemo_UFO_ssx_uvuvx::sigmaKin() 
{
...
double Sigma_GambitDemo_UFO_ssx_uvuvx::sigmaHat() 
{
...
void Sigma_GambitDemo_UFO_ssx_uvuvx::setIdColAcol() 
{
  if(id1 == -3 && id2 == 3)
  {
  ...
  // Pick color flow
  int ncolor[1] = {2}; 
  if((id1 == 3 && id2 == -3 && id3 == 9000005 && id4 == -9000005))
  {
    vector<double> probs; 
  ...
  else if((id1 == -3 && id2 == 3 && id3 == 9000005 && id4 == -9000005))
  {
    vector<double> probs; 
    double sum = jamp2[0][0] + jamp2[0][1]; 
    for(int i = 0; i < ncolor[0]; i++ )
...
double Sigma_GambitDemo_UFO_ssx_uvuvx::weightDecay(Event& process, int iResBeg,
    int iResEnd)
{
...
void Sigma_GambitDemo_UFO_ssx_uvuvx::calculate_wavefunctions(const int perm[],
    const int hel[])
{
...
double Sigma_GambitDemo_UFO_ssx_uvuvx::matrix_ssx_uvuvx() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 1; 
