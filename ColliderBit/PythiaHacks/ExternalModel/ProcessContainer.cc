...
bool SetupContainers::init(vector<ProcessContainer*>& containerPtrs,
  ...
  if (settings.flag("UserModel:all")) {
    sigmaPtr = new Sigma_GambitDemo_UFO_ccx_uvuvx();
    containerPtrs.push_back( new ProcessContainer(sigmaPtr) );
    sigmaPtr = new Sigma_GambitDemo_UFO_ddx_uvuvx();
    containerPtrs.push_back( new ProcessContainer(sigmaPtr) );
    sigmaPtr = new Sigma_GambitDemo_UFO_gg_uvuvx();
    containerPtrs.push_back( new ProcessContainer(sigmaPtr) );
    sigmaPtr = new Sigma_GambitDemo_UFO_ssx_uvuvx();
    containerPtrs.push_back( new ProcessContainer(sigmaPtr) );
    sigmaPtr = new Sigma_GambitDemo_UFO_uux_uvuvx();
    containerPtrs.push_back( new ProcessContainer(sigmaPtr) );
  }
