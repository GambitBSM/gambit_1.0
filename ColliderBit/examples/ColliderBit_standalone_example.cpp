...
// const std::string inputFileName = "ColliderBit/data/ExternalModel_point.slha";
...
int main(int argc, char* argv[])
{
  ...
  try{
    ...
    // "Pythia_external" in ColliderBit/src/colliders/SpecializablePythia.cpp. This collider has no pre-defined configuration,
    // so we will need to specify all settings below.
    // 
    ...
    //       in ColliderBit/src/CollderBit.cpp, in a similar manner to what is done there.
