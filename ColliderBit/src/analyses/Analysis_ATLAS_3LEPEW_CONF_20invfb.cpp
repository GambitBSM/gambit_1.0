...
namespace Gambit {
  namespace ColliderBit {
    ...
    class Analysis_ATLAS_3LEPEW_CONF_20invfb : public HEPUtilsAnalysis {
    private:
    ...
    public:
      ...
      void ElecElecOverlapRemoval(vector<HEPUtils::Particle*> &vec1, vector<HEPUtils::Particle*> &vec2, double DeltaRMax) {
