...
# Check for gccxml (requred by BOSS)
find_program(GCCXML_PATH gccxml)
if(NOT GCCXML_PATH)
  message("${BoldRed}-- GCCXML not found. Backends requiring BOSS will not be built. ")
  message("   Please install GCCXML and setup your environment to find the 'gccxml' executable. ${ColourReset}" )
endif()
