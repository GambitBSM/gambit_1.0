...
macro(BOSS_backend cmake_project backend_name backend_version)
  ...
  if(NOT EXISTS ${config_file_path})
    message("${BoldRed}-- The config file ${config_file_path} required to BOSS the backend ${backend_name} ${backend_version} was not found. No BOSS step generated. ${ColourReset}")
    ...
    ExternalProject_Add_Step(${cmake_project} BOSS
      ...
      # TODO: Copy files generated by BOSS to the correct paths within Backends/include/...
      DEPENDEES patch
      DEPENDERS configure
    )
  endif()
