...
input_files = [
    '../../../Backends/installed/gm2calc/1.1.2/src/MSSMNoFV_onshell.hpp',
    '../../../Backends/installed/gm2calc/1.1.2/src/gm2_1loop.hpp',
    '../../../Backends/installed/gm2calc/1.1.2/src/gm2_2loop.hpp',
    '../../../Backends/installed/gm2calc/1.1.2/src/gm2_uncertainty.hpp',
]
include_paths = [
    '../../../Backends/installed/gm2calc/1.1.2/src', 
    '../../../contrib/eigen3'
]
base_paths = ['../../../Backends/installed/gm2calc/1.1.2']

header_files_to = '../../../Backends/installed/gm2calc/1.1.2/src'
src_files_to    = '../../../Backends/installed/gm2calc/1.1.2/src'
