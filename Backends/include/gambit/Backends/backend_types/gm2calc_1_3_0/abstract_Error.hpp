   ...
   namespace gm2calc
   {
      class Abstract_Error : public virtual AbstractBase
      {
         ...
         public:
            ...
            {
               std::cerr << "BOSS WARNING: Problem detected with the BOSSed class gm2calc::Error from backend gm2calc_1_3_0. The function Abstract_Error::init_wrapper() in GAMBIT should never have been called..." << std::endl;
            }
            ...
            virtual ~Abstract_Error()
            {
               std::cerr << "BOSS WARNING: Problem detected with the BOSSed class gm2calc::Error from backend gm2calc_1_3_0. The function Abstract_Error::~Abstract_Error in GAMBIT should never have been called..." << std::endl;
            }
      };
   }
