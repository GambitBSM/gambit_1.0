   ...
   namespace gm2calc
   {
      class Abstract_EInvalidInput : virtual public gm2calc::Abstract_Error
      {
         ...
         public:
            ...
            {
               std::cerr << "BOSS WARNING: Problem detected with the BOSSed class gm2calc::EInvalidInput from backend gm2calc_1_3_0. The function Abstract_EInvalidInput::init_wrapper() in GAMBIT should never have been called..." << std::endl;
            }
            ...
            {
               std::cerr << "BOSS WARNING: Problem detected with the BOSSed class gm2calc::EInvalidInput from backend gm2calc_1_3_0. The function Abstract_EInvalidInput::~Abstract_EInvalidInput in GAMBIT should never have been called..." << std::endl;
            }
      };
   }
