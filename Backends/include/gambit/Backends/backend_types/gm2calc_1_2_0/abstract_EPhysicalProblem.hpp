   ...
   namespace gm2calc
   {
      class Abstract_EPhysicalProblem : virtual public gm2calc::Abstract_Error
      {
         ...
         public:
            ...
            {
               std::cerr << "BOSS WARNING: Problem detected with the BOSSed class gm2calc::EPhysicalProblem from backend gm2calc_1_2_0. The function Abstract_EPhysicalProblem::init_wrapper() in GAMBIT should never have been called..." << std::endl;
            }
            ...
            {
               std::cerr << "BOSS WARNING: Problem detected with the BOSSed class gm2calc::EPhysicalProblem from backend gm2calc_1_2_0. The function Abstract_EPhysicalProblem::~Abstract_EPhysicalProblem in GAMBIT should never have been called..." << std::endl;
            }
      };
   }
