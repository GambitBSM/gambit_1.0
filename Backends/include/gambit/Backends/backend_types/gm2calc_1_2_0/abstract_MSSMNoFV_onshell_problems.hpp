   ...
   namespace gm2calc
   {
      class Abstract_MSSMNoFV_onshell_problems : public virtual AbstractBase
      {
         ...
         public:
            ...
            {
               std::cerr << "BOSS WARNING: Problem detected with the BOSSed class gm2calc::MSSMNoFV_onshell_problems from backend gm2calc_1_2_0. The function Abstract_MSSMNoFV_onshell_problems::init_wrapper() in GAMBIT should never have been called..." << std::endl;
            }
            ...
            {
               std::cerr << "BOSS WARNING: Problem detected with the BOSSed class gm2calc::MSSMNoFV_onshell_problems from backend gm2calc_1_2_0. The function Abstract_MSSMNoFV_onshell_problems::~Abstract_MSSMNoFV_onshell_problems in GAMBIT should never have been called..." << std::endl;
            }
      };
   }
