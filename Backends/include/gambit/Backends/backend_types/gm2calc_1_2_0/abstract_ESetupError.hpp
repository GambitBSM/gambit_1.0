   ...
   namespace gm2calc
   {
      class Abstract_ESetupError : virtual public gm2calc::Abstract_Error
      {
         ...
         public:
            ...
            {
               std::cerr << "BOSS WARNING: Problem detected with the BOSSed class gm2calc::ESetupError from backend gm2calc_1_2_0. The function Abstract_ESetupError::init_wrapper() in GAMBIT should never have been called..." << std::endl;
            }
            ...
            {
               std::cerr << "BOSS WARNING: Problem detected with the BOSSed class gm2calc::ESetupError from backend gm2calc_1_2_0. The function Abstract_ESetupError::~Abstract_ESetupError in GAMBIT should never have been called..." << std::endl;
            }
      };
   }
