   ...
   namespace gm2calc
   {
      class Abstract_MSSMNoFV_onshell : virtual public gm2calc::Abstract_MSSMNoFV_onshell_mass_eigenstates
      {
         ...
         public:
            ...
            {
               std::cerr << "BOSS WARNING: Problem detected with the BOSSed class gm2calc::MSSMNoFV_onshell from backend gm2calc_1_2_0. The function Abstract_MSSMNoFV_onshell::init_wrapper() in GAMBIT should never have been called..." << std::endl;
            }
            ...
            {
               std::cerr << "BOSS WARNING: Problem detected with the BOSSed class gm2calc::MSSMNoFV_onshell from backend gm2calc_1_2_0. The function Abstract_MSSMNoFV_onshell::~Abstract_MSSMNoFV_onshell in GAMBIT should never have been called..." << std::endl;
            }
      };
   }
