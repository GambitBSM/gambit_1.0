   ...
   namespace gm2calc
   {
      class Abstract_MSSMNoFV_onshell_susy_parameters : public virtual AbstractBase
      {
         ...
         public:
            ...
            {
               std::cerr << "BOSS WARNING: Problem detected with the BOSSed class gm2calc::MSSMNoFV_onshell_susy_parameters from backend gm2calc_1_0_0. The function Abstract_MSSMNoFV_onshell_susy_parameters::init_wrapper() in GAMBIT should never have been called..." << std::endl;
            }
            ...
            {
               std::cerr << "BOSS WARNING: Problem detected with the BOSSed class gm2calc::MSSMNoFV_onshell_susy_parameters from backend gm2calc_1_0_0. The function Abstract_MSSMNoFV_onshell_susy_parameters::~Abstract_MSSMNoFV_onshell_susy_parameters in GAMBIT should never have been called..." << std::endl;
            }
      };
   }
