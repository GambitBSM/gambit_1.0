#ifndef __wrapper_MSSMNoFV_onshell_decl_gm2calc_1_0_0_hpp__
#define __wrapper_MSSMNoFV_onshell_decl_gm2calc_1_0_0_hpp__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
   ...
   namespace gm2calc
   {
      ...
      class MSSMNoFV_onshell : public WrapperBase<gm2calc::Abstract_MSSMNoFV_onshell>, public MSSMNoFV_onshell_mass_eigenstates
      {
         public:
            typedef WrapperBase<gm2calc::Abstract_MSSMNoFV_onshell> wrapperbase;
            using WrapperBase<gm2calc::Abstract_MSSMNoFV_onshell>::BEptr;
         ...
         public:
            ...
            const ::Eigen::Array<double, 2, 1, 0, 2, 1>& get_MSmu() const;
      
            const ::Eigen::Matrix<double, 2, 2, 0, 2, 2>& get_USmu() const;
      
            const ::Eigen::Matrix<double, 2, 2, 0, 2, 2>& get_UStau() const;
      
            const ::Eigen::Array<double, 2, 1, 0, 2, 1>& get_MSbot() const;
      
            const ::Eigen::Matrix<double, 2, 2, 0, 2, 2>& get_USbot() const;
      
            const ::Eigen::Array<double, 2, 1, 0, 2, 1>& get_MStop() const;
      
            const ::Eigen::Matrix<double, 2, 2, 0, 2, 2>& get_UStop() const;
         ...
         public:
            ...
            MSSMNoFV_onshell(gm2calc::Abstract_MSSMNoFV_onshell* const & in, bool);
...
#endif /* __wrapper_MSSMNoFV_onshell_decl_gm2calc_1_0_0_hpp__ */
