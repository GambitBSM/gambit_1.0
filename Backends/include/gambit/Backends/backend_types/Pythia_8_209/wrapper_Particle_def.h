#ifndef __wrapper_Particle_def_Pythia_8_209_h__
#define __wrapper_Particle_def_Pythia_8_209_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
    ...
    namespace Pythia8
    {
        ...
        {
            return wrapperbase::BEptr->iTopCopyId(simplify);
        }
        
        inline int Particle::iTopCopyId() const
        {
            return wrapperbase::BEptr->iTopCopyId__BOSS();
        }
        
        inline int Particle::iBotCopyId(bool simplify) const
        {
            return wrapperbase::BEptr->iBotCopyId(simplify);
        }
        ...
        {
            return wrapperbase::BEptr->isFinalPartonLevel();
        }
        ...
        inline void Pythia8::Particle::_memberVariablesInit()
        {
        }
...
#endif /* __wrapper_Particle_def_Pythia_8_209_h__ */
