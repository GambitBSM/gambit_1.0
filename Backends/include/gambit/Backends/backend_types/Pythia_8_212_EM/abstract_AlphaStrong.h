#ifndef __abstract_AlphaStrong_Pythia_8_212_EM_h__
#define __abstract_AlphaStrong_Pythia_8_212_EM_h__
    ...
    namespace Pythia8
    {
        class Abstract_AlphaStrong : public virtual AbstractBase
        {
            ...
            public:
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::AlphaStrong from backend Pythia_8_212_EM. The function Abstract_AlphaStrong::init_wrapper() in GAMBIT should never have been called..." << std::endl;
                }
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::AlphaStrong from backend Pythia_8_212_EM. The function Abstract_AlphaStrong::~Abstract_AlphaStrong in GAMBIT should never have been called..." << std::endl;
                }
        };
    }
...
#endif /* __abstract_AlphaStrong_Pythia_8_212_EM_h__ */
