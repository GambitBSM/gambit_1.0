#ifndef __abstract_SigmaTotal_Pythia_8_212_EM_h__
#define __abstract_SigmaTotal_Pythia_8_212_EM_h__
    ...
    namespace Pythia8
    {
        class Abstract_SigmaTotal : public virtual AbstractBase
        {
            ...
            public:
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::SigmaTotal from backend Pythia_8_212_EM. The function Abstract_SigmaTotal::init_wrapper() in GAMBIT should never have been called..." << std::endl;
                }
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::SigmaTotal from backend Pythia_8_212_EM. The function Abstract_SigmaTotal::~Abstract_SigmaTotal in GAMBIT should never have been called..." << std::endl;
                }
        };
    }
...
#endif /* __abstract_SigmaTotal_Pythia_8_212_EM_h__ */
