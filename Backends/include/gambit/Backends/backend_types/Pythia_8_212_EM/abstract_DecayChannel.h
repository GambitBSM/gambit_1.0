#ifndef __abstract_DecayChannel_Pythia_8_212_EM_h__
#define __abstract_DecayChannel_Pythia_8_212_EM_h__
    ...
    namespace Pythia8
    {
        class Abstract_DecayChannel : public virtual AbstractBase
        {
            ...
            public:
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::DecayChannel from backend Pythia_8_212_EM. The function Abstract_DecayChannel::init_wrapper() in GAMBIT should never have been called..." << std::endl;
                }
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::DecayChannel from backend Pythia_8_212_EM. The function Abstract_DecayChannel::~Abstract_DecayChannel in GAMBIT should never have been called..." << std::endl;
                }
        };
    }
...
#endif /* __abstract_DecayChannel_Pythia_8_212_EM_h__ */
