#ifndef __abstract_SLHAinterface_Pythia_8_212_EM_h__
#define __abstract_SLHAinterface_Pythia_8_212_EM_h__
    ...
    namespace Pythia8
    {
        class Abstract_SLHAinterface : public virtual AbstractBase
        {
            ...
            public:
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::SLHAinterface from backend Pythia_8_212_EM. The function Abstract_SLHAinterface::init_wrapper() in GAMBIT should never have been called..." << std::endl;
                }
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::SLHAinterface from backend Pythia_8_212_EM. The function Abstract_SLHAinterface::~Abstract_SLHAinterface in GAMBIT should never have been called..." << std::endl;
                }
        };
    }
...
#endif /* __abstract_SLHAinterface_Pythia_8_212_EM_h__ */
