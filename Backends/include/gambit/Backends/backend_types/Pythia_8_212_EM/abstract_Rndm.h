...
void set_delete_BEptr(CAT_3(BACKENDNAME,_,SAFE_VERSION)::Pythia8::Rndm*, bool);
...
CAT_3(BACKENDNAME,_,SAFE_VERSION)::Pythia8::Rndm* wrapper_creator(CAT_3(BACKENDNAME,_,SAFE_VERSION)::Pythia8::Abstract_Rndm*);
