#ifndef __abstract_Hist_Pythia_8_212_EM_h__
#define __abstract_Hist_Pythia_8_212_EM_h__
    ...
    namespace Pythia8
    {
        class Abstract_Hist : public virtual AbstractBase
        {
            ...
            public:
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::Hist from backend Pythia_8_212_EM. The function Abstract_Hist::init_wrapper() in GAMBIT should never have been called..." << std::endl;
                }
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::Hist from backend Pythia_8_212_EM. The function Abstract_Hist::~Abstract_Hist in GAMBIT should never have been called..." << std::endl;
                }
        };
    }
...
#endif /* __abstract_Hist_Pythia_8_212_EM_h__ */
