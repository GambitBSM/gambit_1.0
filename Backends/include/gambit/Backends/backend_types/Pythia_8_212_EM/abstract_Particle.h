#ifndef __abstract_Particle_Pythia_8_212_EM_h__
#define __abstract_Particle_Pythia_8_212_EM_h__
    ...
    namespace Pythia8
    {
        class Abstract_Particle : public virtual AbstractBase
        {
            ...
            public:
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::Particle from backend Pythia_8_212_EM. The function Abstract_Particle::init_wrapper() in GAMBIT should never have been called..." << std::endl;
                }
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::Particle from backend Pythia_8_212_EM. The function Abstract_Particle::~Abstract_Particle in GAMBIT should never have been called..." << std::endl;
                }
        };
    }
...
#endif /* __abstract_Particle_Pythia_8_212_EM_h__ */
