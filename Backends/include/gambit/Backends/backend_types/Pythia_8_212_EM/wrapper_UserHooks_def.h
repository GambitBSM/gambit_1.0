#ifndef __wrapper_UserHooks_def_Pythia_8_212_EM_h__
#define __wrapper_UserHooks_def_Pythia_8_212_EM_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
    ...
    namespace Pythia8
    {
        ...
        {
            wrapperbase::BEptr->setEnhancedEventWeight(wt);
        }
        
        inline double UserHooks::getEnhancedEventWeight()
        {
            return wrapperbase::BEptr->getEnhancedEventWeight();
        }
        
        inline bool UserHooks::canEnhanceTrial()
        {
            return wrapperbase::BEptr->canEnhanceTrial();
        }
        
        inline void UserHooks::setEnhancedTrial(double pTIn, double wtIn)
        {
            wrapperbase::BEptr->setEnhancedTrial(pTIn, wtIn);
        }
        
        inline double UserHooks::getEnhancedTrialPT()
        {
            return wrapperbase::BEptr->getEnhancedTrialPT();
        }
        
        inline double UserHooks::getEnhancedTrialWeight()
        {
            return wrapperbase::BEptr->getEnhancedTrialWeight();
        }
        
        inline bool UserHooks::canChangeFragPar()
        {
            return wrapperbase::BEptr->canChangeFragPar();
        }
        
        inline bool UserHooks::doVetoFragmentation(WrapperBase< Pythia8::Abstract_Particle > arg_1)
        {
            return wrapperbase::BEptr->doVetoFragmentation__BOSS(*arg_1.BEptr);
        }
        ...
        inline void Pythia8::UserHooks::_memberVariablesInit()
        {
        }
...
#endif /* __wrapper_UserHooks_def_Pythia_8_212_EM_h__ */
