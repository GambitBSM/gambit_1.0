#ifndef __abstract_SusyLesHouches_Pythia_8_212_EM_h__
#define __abstract_SusyLesHouches_Pythia_8_212_EM_h__
    ...
    namespace Pythia8
    {
        class Abstract_SusyLesHouches : public virtual AbstractBase
        {
            ...
            public:
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::SusyLesHouches from backend Pythia_8_212_EM. The function Abstract_SusyLesHouches::init_wrapper() in GAMBIT should never have been called..." << std::endl;
                }
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::SusyLesHouches from backend Pythia_8_212_EM. The function Abstract_SusyLesHouches::~Abstract_SusyLesHouches in GAMBIT should never have been called..." << std::endl;
                }
        };
    }
...
#endif /* __abstract_SusyLesHouches_Pythia_8_212_EM_h__ */
