    ...
    namespace Pythia8
    {
        class Abstract_CoupSUSY : virtual public Pythia8::Abstract_Couplings
        {
            ...
            public:
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::CoupSUSY from backend Pythia_8_212_EM. The function Abstract_CoupSUSY::init_wrapper() in GAMBIT should never have been called..." << std::endl;
                }
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::CoupSUSY from backend Pythia_8_212_EM. The function Abstract_CoupSUSY::~Abstract_CoupSUSY in GAMBIT should never have been called..." << std::endl;
                }
        };
    }
