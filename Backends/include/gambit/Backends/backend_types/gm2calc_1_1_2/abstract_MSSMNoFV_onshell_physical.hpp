#ifndef __abstract_MSSMNoFV_onshell_physical_gm2calc_1_1_2_hpp__
#define __abstract_MSSMNoFV_onshell_physical_gm2calc_1_1_2_hpp__
   ...
   namespace gm2calc
   {
      class Abstract_MSSMNoFV_onshell_physical : public virtual AbstractBase
      {
         ...
         public:
            ...
            {
               std::cerr << "BOSS WARNING: Problem detected with the BOSSed class gm2calc::MSSMNoFV_onshell_physical from backend gm2calc_1_1_2. The function Abstract_MSSMNoFV_onshell_physical::init_wrapper() in GAMBIT should never have been called..." << std::endl;
            }
            ...
            {
               std::cerr << "BOSS WARNING: Problem detected with the BOSSed class gm2calc::MSSMNoFV_onshell_physical from backend gm2calc_1_1_2. The function Abstract_MSSMNoFV_onshell_physical::~Abstract_MSSMNoFV_onshell_physical in GAMBIT should never have been called..." << std::endl;
            }
      };
   }
...
#endif /* __abstract_MSSMNoFV_onshell_physical_gm2calc_1_1_2_hpp__ */
