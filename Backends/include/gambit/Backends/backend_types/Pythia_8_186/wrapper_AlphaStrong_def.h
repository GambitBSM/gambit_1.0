#ifndef __wrapper_AlphaStrong_def_Pythia_8_186_h__
#define __wrapper_AlphaStrong_def_Pythia_8_186_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
    ...
    namespace Pythia8
    {
        ...
        inline Pythia8::AlphaStrong::AlphaStrong(double valueIn, int orderIn) :
            WrapperBase<Pythia8::Abstract_AlphaStrong>(__factory1(valueIn, orderIn))
        {
            wrapperbase::BEptr->wrapper__BOSS(this);
            wrapperbase::BEptr->can_delete_wrapper(false);  // Override setting in wrapper__BOSS
        }
        
        inline Pythia8::AlphaStrong::AlphaStrong(double valueIn) :
            WrapperBase<Pythia8::Abstract_AlphaStrong>(__factory2(valueIn))
        {
            wrapperbase::BEptr->wrapper__BOSS(this);
            wrapperbase::BEptr->can_delete_wrapper(false);  // Override setting in wrapper__BOSS
        }
...
#endif /* __wrapper_AlphaStrong_def_Pythia_8_186_h__ */
