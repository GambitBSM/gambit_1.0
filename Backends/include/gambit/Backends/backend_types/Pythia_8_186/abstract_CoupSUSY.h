#ifndef __abstract_CoupSUSY_Pythia_8_186_h__
#define __abstract_CoupSUSY_Pythia_8_186_h__
    ...
    namespace Pythia8
    {
        class Abstract_CoupSUSY : virtual public AbstractBase, virtual public Pythia8::Abstract_Couplings
        {
            public:
                ...
                // IGNORED: Field  -- Name: slhaPtr  -- XML id: _20440
            private:
                // IGNORED: Variable  -- Name: DBSUSY  -- XML id: _20441
                // IGNORED: Field  -- Name: infoPtr  -- XML id: _20442
                // IGNORED: Field  -- Name: settingsPtr  -- XML id: _20443
                // IGNORED: Field  -- Name: particleDataPtr  -- XML id: _20444
            public:
                ...
                virtual std::basic_string<char,std::char_traits<char>,std::allocator<char> > getName(int) =0;
...
#endif /* __abstract_CoupSUSY_Pythia_8_186_h__ */
