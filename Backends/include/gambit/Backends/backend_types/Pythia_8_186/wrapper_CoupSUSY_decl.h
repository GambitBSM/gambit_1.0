#ifndef __wrapper_CoupSUSY_decl_Pythia_8_186_h__
#define __wrapper_CoupSUSY_decl_Pythia_8_186_h__
    ...
    namespace Pythia8
    {
        ...
        class CoupSUSY : public WrapperBase<Pythia8::Abstract_CoupSUSY>, public Couplings
        {
            ...
            public:
                ...
                std::basic_string<char,std::char_traits<char>,std::allocator<char> > getName(int pdgCode);
...
#endif /* __wrapper_CoupSUSY_decl_Pythia_8_186_h__ */
