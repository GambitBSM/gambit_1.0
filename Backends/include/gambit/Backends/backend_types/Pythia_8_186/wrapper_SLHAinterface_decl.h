#ifndef __wrapper_SLHAinterface_decl_Pythia_8_186_h__
#define __wrapper_SLHAinterface_decl_Pythia_8_186_h__
    ...
    namespace Pythia8
    {
        ...
        class SLHAinterface : public WrapperBase<Pythia8::Abstract_SLHAinterface>
        {
            ...
            public:
                ...
                void init(WrapperBase< Pythia8::Abstract_Settings >& settings, WrapperBase< Pythia8::Abstract_Rndm >* rndmPtr, WrapperBase< Pythia8::Abstract_Couplings >* couplingsPtrIn, WrapperBase< Pythia8::Abstract_ParticleData >* particleDataPtr, bool& useSHLAcouplings);
...
#endif /* __wrapper_SLHAinterface_decl_Pythia_8_186_h__ */
