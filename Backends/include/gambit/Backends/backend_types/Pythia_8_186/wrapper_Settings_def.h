#ifndef __wrapper_Settings_def_Pythia_8_186_h__
#define __wrapper_Settings_def_Pythia_8_186_h__
...
namespace CAT_3(BACKENDNAME,_,SAFE_VERSION)
{
    ...
    namespace Pythia8
    {
        ...
        {
            wrapperbase::BEptr->addMode(keyIn, defaultIn, hasMinIn, hasMaxIn, minIn, maxIn);
        }
        ...
        inline void Settings::mode(std::basic_string<char,std::char_traits<char>,std::allocator<char> > keyIn, int nowIn)
        {
            wrapperbase::BEptr->mode(keyIn, nowIn);
        }
...
#endif /* __wrapper_Settings_def_Pythia_8_186_h__ */
