    ...
    namespace Pythia8
    {
        class Abstract_ResonanceDecays : public virtual AbstractBase
        {
            ...
            public:
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::ResonanceDecays from backend Pythia_8_212. The function Abstract_ResonanceDecays::init_wrapper() in GAMBIT should never have been called..." << std::endl;
                }
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::ResonanceDecays from backend Pythia_8_212. The function Abstract_ResonanceDecays::~Abstract_ResonanceDecays in GAMBIT should never have been called..." << std::endl;
                }
        };
    }
