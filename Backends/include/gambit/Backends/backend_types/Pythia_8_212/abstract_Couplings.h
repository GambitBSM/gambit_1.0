    ...
    namespace Pythia8
    {
        class Abstract_Couplings : virtual public Pythia8::Abstract_CoupSM
        {
            ...
            public:
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::Couplings from backend Pythia_8_212. The function Abstract_Couplings::init_wrapper() in GAMBIT should never have been called..." << std::endl;
                }
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::Couplings from backend Pythia_8_212. The function Abstract_Couplings::~Abstract_Couplings in GAMBIT should never have been called..." << std::endl;
                }
        };
    }
