    ...
    namespace Pythia8
    {
        class Abstract_AlphaEM : public virtual AbstractBase
        {
            ...
            public:
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::AlphaEM from backend Pythia_8_212. The function Abstract_AlphaEM::init_wrapper() in GAMBIT should never have been called..." << std::endl;
                }
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::AlphaEM from backend Pythia_8_212. The function Abstract_AlphaEM::~Abstract_AlphaEM in GAMBIT should never have been called..." << std::endl;
                }
        };
    }
