    ...
    namespace Pythia8
    {
        class Abstract_Rndm : public virtual AbstractBase
        {
            ...
            public:
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::Rndm from backend Pythia_8_212. The function Abstract_Rndm::init_wrapper() in GAMBIT should never have been called..." << std::endl;
                }
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::Rndm from backend Pythia_8_212. The function Abstract_Rndm::~Abstract_Rndm in GAMBIT should never have been called..." << std::endl;
                }
        };
    }
