    ...
    namespace Pythia8
    {
        class Abstract_Parm : public virtual AbstractBase
        {
            ...
            public:
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::Parm from backend Pythia_8_212. The function Abstract_Parm::init_wrapper() in GAMBIT should never have been called..." << std::endl;
                }
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::Parm from backend Pythia_8_212. The function Abstract_Parm::~Abstract_Parm in GAMBIT should never have been called..." << std::endl;
                }
        };
    }
