    ...
    namespace Pythia8
    {
        class Abstract_ParticleDataEntry : public virtual AbstractBase
        {
            ...
            public:
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::ParticleDataEntry from backend Pythia_8_212. The function Abstract_ParticleDataEntry::init_wrapper() in GAMBIT should never have been called..." << std::endl;
                }
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::ParticleDataEntry from backend Pythia_8_212. The function Abstract_ParticleDataEntry::~Abstract_ParticleDataEntry in GAMBIT should never have been called..." << std::endl;
                }
        };
    }
