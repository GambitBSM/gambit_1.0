    ...
    namespace Pythia8
    {
        class Abstract_CoupSM : public virtual AbstractBase
        {
            ...
            public:
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::CoupSM from backend Pythia_8_212. The function Abstract_CoupSM::init_wrapper() in GAMBIT should never have been called..." << std::endl;
                }
                ...
                {
                    std::cerr << "BOSS WARNING: Problem detected with the BOSSed class Pythia8::CoupSM from backend Pythia_8_212. The function Abstract_CoupSM::~Abstract_CoupSM in GAMBIT should never have been called..." << std::endl;
                }
        };
    }
