...
BE_FUNCTION(calculate_uncertainty_amu_2loop, double, (const gm2calc_1_2_0::gm2calc::MSSMNoFV_onshell&), "calculate_uncertainty_amu_2loop__BOSS_14", "calculate_uncertainty_amu_2loop")
// Variables
