...
BE_INI_FUNCTION
{
  ...
  if(scan_level)
  {
    ...
    int loglevel = 0;  // resum logs? (1 -> NLL, large MSUSY; 2 -> NLL, large MCha,MNeu,MGlu,MSUSY 3 -> NNLL, large MCha,MNeu,MGlu,MSUSY) -> FH recommend 1 or 2, but anything except 0 is buggy.
